    ...
    return function()
    {
        ...
        this.application_onloadingglobalvariables = function(obj,e)
        {
        	...
        	if(nexacro.Browser != "Runtime") { //Runtime 은 로컬에서만 사용
        		...
        		if(sXadlUrl.indexOf("127.0.0.1") > -1){ 
        			application.services["host"].set_url("http://127.0.0.1:8080/");			
        		}
        		
        		if(sXadlUrl.indexOf("localhost") > -1){
        			application.services["host"].set_url("http://localhost:8080/");
        		}
        ...
        this.afn_viewIntro = function(bView)
        {
        	...
        	{
        		if(bView){
        			this.av_vWorkFrameset.set_separatesize("56,30,0,*,0,0");
        		} else {
        			if(!Base.isEmpty(application.gv_linkmenuid))
        			{
        		...
        		if(bView){
        			this.av_vWorkFrameset.set_separatesize("56,0,0,*,0,30");
        		} else {
        			if(!Base.isEmpty(application.gv_linkmenuid))
        			{
        				this.av_vWorkFrameset.set_separatesize("0,0,*,0,0,0");
