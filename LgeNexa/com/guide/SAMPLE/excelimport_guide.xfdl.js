(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("Button01", "absolute", "77.78%", "184", null, "50", "12.42%", null, this);
            obj.set_taborder("7");
            obj.set_text("Button01");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Edit("Edit00", "absolute", "21.73%", "188", null, "20", "57.52%", null, this);
            obj.set_taborder("8");
            this.addChild(obj.name, obj);
        ...
        *------------------------------------------------------------------
        ...
        this.Button00_onclick = function(obj,e)
        {
        	...
        	var nStartrow = 1; // 1부터 시작
        	var sSheetName = this.Edit00.text;
        //	var sSheetName = "03_상세시나리오-WEBWAS";
        //	var sSheetName = "Sheet1";
        	LGE.Core.importExcel(this, sSheetName, this.Dataset00, nStartrow);
        }
        ...
        {
        	trace(system.locale);
        	trace(application.locale);
        	trace(this.Grid00.locale);
        	trace(this.Dataset00.saveXML());
