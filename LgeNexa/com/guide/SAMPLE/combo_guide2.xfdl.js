        ...
        *------------------------------------------------------------------
        ...
        this.fn_initMultiCombo = function()
        {
        	...
        	this.div_multiCombo00.fn_initComp(this, "div_multiCombo00", this.fn_callbackMultiCombo, oParam);
         	...
         	var oParam = {innerdataset:this.ds_inner11, codecolumn:"CODE", datacolumn:"NAME"};
         	this.div_multiCombo01.fn_initComp(this, "div_multiCombo01", this.fn_callbackMultiComboSub , oParam);	
        ...
        {
        	this.ds_inner11.reset();
        	var sValue = this.div_multiCombo00.getValue("CODE");
        	...
        	for(var i=0; i<aValue.length; i++)
        	{
        		if(i == 0)
        		{
        			sFilter = "COL1 =='" + aValue[i] + "' ";
        		} else {
        			sFilter = sFilter + " || COL1 =='" + aValue[i] + "' ";
        		}
        	}
        	this.ds_inner11.filter(sFilter);
        	
        }

        this.fn_callbackMultiComboSub = function()
        {
