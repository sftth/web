(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("transaction_guide2.xfdl", "CommonLibrary::Comm.xjs");
        this.registerScript("transaction_guide2.xfdl", function(exports) {
        ...
        this.loadIncludeScript("transaction_guide2.xfdl", true);
