(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnExcel02", "absolute", null, "439", "153", "24", "588", null, this);
            obj.set_taborder("259");
            obj.set_text("Template Download");
            obj.set_cssclass("btn_WF_GridDown");
            this.addChild(obj.name, obj);

            obj = new Button("btnApprUp", "absolute", null, "397", "38", "24", "224", null, this);
            obj.set_taborder("260");
            obj.set_text("Up");
            this.addChild(obj.name, obj);

            obj = new Button("btnApprDown", "absolute", null, "397", "53", "24", "168", null, this);
            obj.set_taborder("261");
            obj.set_text("Down");
            this.addChild(obj.name, obj);

            obj = new Button("btnApprAdd", "absolute", null, "397", "44", "24", "265", null, this);
            obj.set_taborder("262");
            obj.set_text("Add");
            this.addChild(obj.name, obj);

            obj = new Button("btnMarkDel", "absolute", null, "346", "58", "24", "168", null, this);
            obj.set_taborder("263");
            obj.set_text("Delete");
            this.addChild(obj.name, obj);

            obj = new Button("btnApprAdd00", "absolute", null, "346", "44", "24", "229", null, this);
        ...
        // User Script
        this.registerScript("Guide06.xfdl", function(exports) {
        ...
        this.loadIncludeScript("Guide06.xfdl", true);
