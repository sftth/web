(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("Guide09.xfdl", function(exports) {
        ...
        this.Static165_onclick = function(obj,e)
        {
        	
        }

        this.Static76_onclick = function(obj,e)
        {
        	
        }

        this.Static96_onclick = function(obj,e)
        {
        ...
        this.loadIncludeScript("Guide09.xfdl", true);
