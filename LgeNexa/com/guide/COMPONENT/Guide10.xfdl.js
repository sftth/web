(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("pageSave", "absolute", "4.58%", "144", null, "22", "85.54%", null, this);
            obj.set_taborder("11");
            obj.set_text("Save (MultiUpload)");
            this.addChild(obj.name, obj);

            obj = new Edit("fileIdText", "absolute", "21.98%", "94", null, "21", "50.98%", null, this);
            obj.set_taborder("12");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("search00", "absolute", "4.58%", "94", null, "22", "85.54%", null, this);
            obj.set_taborder("14");
            obj.set_text("Search");
            this.addChild(obj.name, obj);
