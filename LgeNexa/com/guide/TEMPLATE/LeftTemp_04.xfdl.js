(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("LeftTemp_04.xfdl", "CommonLibrary::Comm.xjs");
        this.registerScript("LeftTemp_04.xfdl", function(exports) {
        ...
        this.loadIncludeScript("LeftTemp_04.xfdl", true);
