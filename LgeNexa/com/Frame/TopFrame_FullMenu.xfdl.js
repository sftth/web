(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 0, 245, this.pdiv_submenu,
            	//-- Layout function
            	function(p) {
            		p.set_text("pdiv_submenu");
            		p.style.set_background("#ffffffff");

            	}
            );
            this.pdiv_submenu.addLayout(obj.name, obj);
        ...
        // User Script
        this.registerScript("TopFrame_FullMenu.xfdl", function(exports) {
        /**********************************************************************************************
        * SYSTEM      : 
        * BUSINESS    : 
        ...
        ***********************************************************************************************/
        ...
        this.TopFrame_onload = function(obj,e)
        {
        	...
        	this.fn_getMaxSubMenuCount();
        	this.fn_createTopmenu();
        ...
        this.fn_setRootMenu = function ()
        {
        	...
        	for(var i=0; i<nCnt; i++)
        	{
        		...
        		this.fn_createSubMenuDataset("ds_" + sRootId + "_" + sSubRootId, sSubRootId);
        	}
        ...
        this.fn_createSubmenu = function()
        {
        	...
        	for(var i=0; i<nCnt; i++) {
        		...
        		comp.addEventHandler("oncellclick", this._fn_subMenuOncellclick, this);		
        		comp.show();
        		comps.push(comp);
        ...
        this.fn_createTopmenu = function()
        {
        	...
        	for(var i=0; i<nCnt; i++) {
        		...
        		comp.userCode = sCode;
        		comp.userName = sText;
        		comp.addEventHandler("onclick", this._fnTopMenuOnclick, this);
        		comp.addEventHandler("onmouseenter", this._fnTopMenuOnclick, this);
        ...
        {
        	this.fn_bindDatasetSubmenu(obj.userCode);
         	this.oCurBtn = obj;
         	var nBorder = 3;
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onclick", this.TopFrame_onclick, this);
        ...
        this.loadIncludeScript("TopFrame_FullMenu.xfdl", true);
