(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new PopupDiv("pdiv_menu", "absolute", "17.4%", "64", null, "245", "45.1%", null, this);
        ...
        // User Script
        this.registerScript("TopFrame_PopupMenu.xfdl", function(exports) {
        /**********************************************************************************************
        * SYSTEM      : 
        * BUSINESS    : 
        ...
        ***********************************************************************************************/
        ...
        {
        	this.fn_menuDivOpen(obj);
        }

        this.btn_menu_onmouseenter = function(obj,e)
        {
        	this.fn_menuDivOpen(obj);
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.btn_menu.addEventHandler("onmouseenter", this.btn_menu_onmouseenter, this);

        };

        this.loadIncludeScript("TopFrame_PopupMenu.xfdl", true);
