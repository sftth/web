(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"NAME\" type=\"STRING\" size=\"256\"/><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"COL1\" type=\"STRING\" size=\"256\"/><Column id=\"COL2\" type=\"STRING\" size=\"256\"/><Column id=\"COL3\" type=\"STRING\" size=\"256\"/><Column id=\"CHK\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"NAME\">1</Col><Col id=\"CODE\">aaaa</Col><Col id=\"COL1\">A1</Col><Col id=\"COL2\">B1</Col><Col id=\"COL3\">C1</Col></Row><Row><Col id=\"NAME\">2</Col><Col id=\"CODE\">bbbb</Col><Col id=\"COL1\">A1</Col><Col id=\"COL2\">B1</Col><Col id=\"COL3\">C1</Col></Row><Row><Col id=\"NAME\">3</Col><Col id=\"CODE\">cccc</Col><Col id=\"COL1\">A1</Col><Col id=\"COL2\">B1</Col><Col id=\"COL3\">C1</Col></Row><Row><Col id=\"NAME\">4</Col><Col id=\"CODE\">dddd</Col><Col id=\"COL1\">A1</Col><Col id=\"COL2\">B1</Col><Col id=\"COL3\">C1</Col></Row><Row><Col id=\"NAME\">5</Col><Col id=\"CODE\">eeee</Col><Col id=\"COL1\">A1</Col><Col id=\"COL2\">B1</Col><Col id=\"COL3\">C1</Col></Row><Row><Col id=\"NAME\">1</Col><Col id=\"CODE\">aaaa</Col><Col id=\"COL1\">A1</Col><Col id=\"COL2\">B1</Col><Col id=\"COL3\">C1</Col></Row><Row><Col id=\"NAME\">2</Col><Col id=\"CODE\">bbbb</Col><Col id=\"COL1\">A1</Col><Col id=\"COL2\">B1</Col><Col id=\"COL3\">C1</Col></Row><Row><Col id=\"NAME\">3</Col><Col id=\"CODE\">cccc</Col><Col id=\"COL1\">A1</Col><Col id=\"COL2\">B1</Col><Col id=\"COL3\">C1</Col></Row><Row><Col id=\"NAME\">4</Col><Col id=\"CODE\">dddd</Col><Col id=\"COL1\">A1</Col><Col id=\"COL2\">B1</Col><Col id=\"COL3\">C1</Col></Row><Row><Col id=\"NAME\">5</Col><Col id=\"CODE\">eeee</Col><Col id=\"COL1\">A1</Col><Col id=\"COL2\">B1</Col><Col id=\"COL3\">C1</Col></Row><Row><Col id=\"NAME\">1</Col><Col id=\"CODE\">aaaa</Col><Col id=\"COL1\">A1</Col><Col id=\"COL2\">B1</Col><Col id=\"COL3\">C1</Col></Row><Row><Col id=\"NAME\">2</Col><Col id=\"CODE\">bbbb</Col><Col id=\"COL1\">A1</Col><Col id=\"COL2\">B1</Col><Col id=\"COL3\">C1</Col></Row><Row><Col id=\"NAME\">3</Col><Col id=\"CODE\">cccc</Col><Col id=\"COL1\">A1</Col><Col id=\"COL2\">B1</Col><Col id=\"COL3\">C1</Col></Row><Row><Col id=\"NAME\">4</Col><Col id=\"CODE\">dddd</Col><Col id=\"COL1\">A1</Col><Col id=\"COL2\">B1</Col><Col id=\"COL3\">C1</Col></Row><Row><Col id=\"NAME\">5</Col><Col id=\"CODE\">eeee</Col><Col id=\"COL1\">A1</Col><Col id=\"COL2\">B1</Col><Col id=\"COL3\">C1</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("combo_guide2.xfdl", "CommonLibrary::Comm.xjs");
        this.registerScript("combo_guide2.xfdl", function(exports) {
        /*==================================================================================
        * SYSTEM      : 
        * BUSINESS    : 
        * FILE NAME   : 
        ...
        *------------------------------------------------------------------
        ...
        this.fn_callbackMultiCombo = function()
        {
        	trace("fn_callbackMultiCombo================");
        }

        this.Button00_onclick = function(obj,e)
        {
        	this.div_multiCombo00.set_value("2");
        }

        this.Button01_onclick = function(obj,e)
        {
        	alert(this.div_multiCombo00.getValue());
        }
        ...
        this.loadIncludeScript("combo_guide2.xfdl", true);
