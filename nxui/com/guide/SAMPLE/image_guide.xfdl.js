    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_classname("image_guide");
            ...
            obj = new Static("Static01", "absolute", "1", "352", null, "68", "81.13%", null, this);
            obj.set_taborder("6");
            obj.set_text("cell\r\nautosizecol : limitmin\r\nautosizerow : limitmin");
            obj.style.set_background("aliceblue");
            obj.style.set_padding("0 0 0 10");
            this.addChild(obj.name, obj);

            obj = new Static("Static02", "absolute", "1", "240", null, "36", "81.13%", null, this);
            obj.set_taborder("7");
            obj.set_text("필수 설정");
            obj.style.set_background("aliceblue");
            obj.style.set_padding("0 0 0 10");
        ...
        // User Script
        this.addIncludeScript("image_guide.xfdl", "CommonLibrary::Comm.xjs");
        this.registerScript("image_guide.xfdl", function(exports) {
        ...
        this.Dataset00_onrowposchanged = function(obj,e)
        {
        	...
        	sUrl = sUrl.replace("#1",sFileId);
        	sUrl = sUrl.replace("#2",sFileSeq);
        	this.ImageViewer00.set_image(sUrl);
        }
        ...
        this.loadIncludeScript("image_guide.xfdl", true);
