    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("frmFillFunction");
                this.set_classname("frmFillFunction");
                this.set_titletext("Fill Function");
            ...
            obj = new Layout("default", "", 1024, 768, this,
            	//-- Layout function
            	function(p) {
            		p.set_classname("frmFillFunction");
            		p.set_titletext("Fill Function");
        ...
        // User Script
        this.addIncludeScript("frmFillFunction.xfdl", "CommonLibrary::Comm.xjs");
        this.registerScript("frmFillFunction.xfdl", function(exports) {
        ...
        */
        ...
        {
            this.addEventHandler("onload", this.frmFillFunction_onload, this);
            this.addEventHandler("onbeforeclose", this.frmFillFunction_onbeforeclose, this);

        };

        this.loadIncludeScript("frmFillFunction.xfdl", true);
