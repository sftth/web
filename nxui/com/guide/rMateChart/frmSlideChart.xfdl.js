    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_classname("frmSlideChart");
        ...
        // User Script
        this.addIncludeScript("frmSlideChart.xfdl", "CommonLibrary::Comm.xjs");
        ...
        this.frmSlideChart_onload = function(obj,e) {
        ...
        this.getCartesianLayout = function(type,title,dataField) {
        	var layout="<rMateChart borderStyle='none' cornerRadius='12'>"
        ...
        // 레이더 차트 레이아웃.
        var radarLayout = "<rMateChart borderStyle='none' cornerRadius='12'>"
        ...
        {
            this.addEventHandler("onload", this.frmSlideChart_onload, this);
