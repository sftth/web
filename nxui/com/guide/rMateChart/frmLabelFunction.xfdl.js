    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_classname("frmLabelFunction");
        ...
        // User Script
        this.addIncludeScript("frmLabelFunction.xfdl", "CommonLibrary::Comm.xjs");
        this.registerScript("frmLabelFunction.xfdl", function(exports) {
        ...
        */
        ...
        this.loadIncludeScript("frmLabelFunction.xfdl", true);
