    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("frmTwoChart");
                this.set_classname("frmTwoChart");
                this.set_titletext("Two Chart Form");
            ...
            obj = new WebBrowser("chart1", "absolute", "1.56%", "1.56%", "47.5%", "91%", null, null, this);
            obj.set_taborder("0");
            this.addChild(obj.name, obj);

            obj = new WebBrowser("chart2", "absolute", "50.78%", "1.69%", "47.66%", "91.02%", null, null, this);
            obj.set_taborder("1");
            this.addChild(obj.name, obj);

            obj = new Button("Button00", "absolute", "33.79%", "94.53%", "14.65%", "3.39%", null, null, this);
            obj.set_taborder("2");
            obj.set_text("Save As Image");
            this.addChild(obj.name, obj);

            obj = new Button("Button01", "absolute", "83.79%", "94.53%", "14.65%", "3.39%", null, null, this);
            obj.set_taborder("3");
            obj.set_text("Save As Image");
            this.addChild(obj.name, obj);
            ...
            obj = new Layout("default", "", 1024, 768, this,
            	//-- Layout function
            	function(p) {
            		p.set_classname("frmTwoChart");
            		p.set_titletext("Two Chart Form");
        ...
        // User Script
        this.addIncludeScript("frmTwoChart.xfdl", "CommonLibrary::Comm.xjs");
        this.registerScript("frmTwoChart.xfdl", function(exports) {
        ...
        this.frmTwoChart_onload = function(obj,e) {
        ...
        this.frmTwoChart_onbeforeclose = function(obj,e) {
        ...
        */
        ...
        {
            this.addEventHandler("onload", this.frmTwoChart_onload, this);
            this.addEventHandler("onbeforeclose", this.frmTwoChart_onbeforeclose, this);
            this.Button00.addEventHandler("onclick", this.Button00_onclick, this);
            this.Button01.addEventHandler("onclick", this.Button01_onclick, this);

        };

        this.loadIncludeScript("frmTwoChart.xfdl", true);
