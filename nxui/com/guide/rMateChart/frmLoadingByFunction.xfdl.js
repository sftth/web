    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_classname("frmLoadingByFunction");
        ...
        // User Script
        this.addIncludeScript("frmLoadingByFunction.xfdl", "CommonLibrary::Comm.xjs");
        ...
        this.frmLoadingByFunction_onload = function(obj,e) {
        ...
        {
            this.addEventHandler("onload", this.frmLoadingByFunction_onload, this);
