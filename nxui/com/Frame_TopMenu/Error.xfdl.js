    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("ErrorPopup");
                this.set_classname("Template12");
                this.set_titletext("Error");
            ...
            obj = new Layout("default", "", 350, 200, this,
            	//-- Layout function
            	function(p) {
            		p.set_classname("Template12");
            		p.set_titletext("Error");
        ...
        * SYSTEM      : 
        * BUSINESS    : 
        * FILE NAME   : Error.xfdl
        * PROGRAMMER  : 
        * DATE        : 2016-09-28
        * DESCRIPTION : User Error Popup 
        *----------------------------------------------------------------------------------------------
        ...
        ***********************************************************************************************/
        ...
        this.ErrorPopup_onload = function(obj,e)
        {
        ...
        {
            this.addEventHandler("onload", this.ErrorPopup_onload, this);
