    ...
    return function()
    {
        ...
        ***********************************************************************************************/
        ...
        this.form_onload = function(obj,e) {
        	//this.cal_from_date.dropbutton.set_visible(false);
        }
        ...
        this.fn_openPopupDiv = function()
        {
        	...
        	this.btn_user_setfocus("from" ,sM);
        	this.btn_user_setfocus("to" ,eM);
        ...
        this.btn_user_setfocus = function(type,month)
        {
        	...
        	eval("this._pdiv_month.btn_" + type + "_" + month + ".style.set_border('1 solid #808080ff ')");
        }
        ...
        this.btn_common_onclick = function(obj,e) {
        	...
        	this.btn_user_setfocus(type, (obj.name).split("_")[2]);	
        }
        ...
        this._cal_to_date_oneditclick = function(obj,e)
        {
        ...
        this._cal_to_date_onchanged = function(obj,e)
        {
        	...
        	if(Base.isEmpty(this._cal_from_date.value)) return true;
        ...
        this.on_initEvent = function()
        {
            ...
            this._cal_to_date.addEventHandler("oneditclick", this._cal_to_date_oneditclick, this);
