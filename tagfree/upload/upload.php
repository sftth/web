...
?>
    ...
    <script type="text/javascript">
		window.onload = function () {
			...
			// XFE 2.5 추가.
			var dialogType = document.getElementById("dialogType").innerHTML;
  ...
  <body>
  	<div style="display:none;" id="dialogType"><?php echo $dialogType ?></div> <!-- XFE 2.5 추가. -->
    <div id="divContentType"><?php echo $sContentType ?></div>
    <div id="divImagePath"><?php echo $sImagePath ?></div>
    <div id="imageWidth"><?php echo $width ?></div>
	<div id="imageHeight"><?php echo $height ?></div>	
	<div id="fileLength"><?php echo $sImagePath ?></div>	
  </body>
</html>
