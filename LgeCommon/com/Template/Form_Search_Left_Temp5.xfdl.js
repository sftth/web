    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("Form_Search_Left_Temp5");
        ...
        // User Script
        this.addIncludeScript("Form_Search_Left_Temp5.xfdl", "CommonLibrary::Comm.xjs");
        this.registerScript("Form_Search_Left_Temp5.xfdl", function(exports) {

        // Library Include
        if (this.executeIncludeScript) { this.executeIncludeScript("CommonLibrary::Comm.xjs", null, exports); }	//include "CommonLibrary::Comm.xjs";

        // Form onload
        this.Form_Search_Left_Temp5_onload = function(obj,e)
        {
        ...
        {
            this.addEventHandler("onload", this.Form_Search_Left_Temp5_onload, this);
            this.btn_SearchSlide.addEventHandler("onclick", this.btn_SearchSlide_onclick, this);

        };

        this.loadIncludeScript("Form_Search_Left_Temp5.xfdl", true);
