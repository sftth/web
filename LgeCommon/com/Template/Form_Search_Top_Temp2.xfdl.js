    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("Form_Search_Top_Temp2");
            ...
            obj = new Grid("grd_CD", "absolute", "0", "37", null, null, "0", "20", this.div_Data.div_Grid);
            obj.set_taborder("50");
            obj.set_binddataset("gd_grid");
            ...
            this.div_Data.div_Grid.addChild(obj.name, obj);
            obj = new Static("Static02", "absolute", "555", "0", "30", "37", null, null, this.div_Data.div_Grid);
            obj.set_taborder("52");
            obj.set_text("h37");
            obj.set_cssclass("Guide_Color");
            obj.set_visible("false");
        ...
        // User Script
        this.addIncludeScript("Form_Search_Top_Temp2.xfdl", "CommonLibrary::Comm.xjs");
        this.registerScript("Form_Search_Top_Temp2.xfdl", function(exports) {

        // Library Include
        if (this.executeIncludeScript) { this.executeIncludeScript("CommonLibrary::Comm.xjs", null, exports); }	//include "CommonLibrary::Comm.xjs";

        // Form onload
        this.Form_Search_Top_Temp2_onload = function(obj,e)
        {
        ...
        // Grid 우클릭 
        this.div_Data_div_Grid_grd_CD_onrbuttonup = function(obj,e)
        {
        ...
        {
            this.addEventHandler("onload", this.Form_Search_Top_Temp2_onload, this);
            this.div_Data.div_Grid.grd_CD.addEventHandler("onrbuttonup", this.div_Data_div_Grid_grd_CD_onrbuttonup, this);
            this.btn_SearchSlide.addEventHandler("onclick", this.btn_SearchSlide_onclick, this);

        };

        this.loadIncludeScript("Form_Search_Top_Temp2.xfdl", true);
