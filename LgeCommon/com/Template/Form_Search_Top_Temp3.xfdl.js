    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("Form_Search_Top_Temp3");
            ...
            obj.set_cssclass("sta_WFDA_Data");
            this.div_Data.addChild(obj.name, obj);
            obj = new Static("Static13", "absolute", "0", null, null, "29", "0", "0", this.div_Data);
            obj.set_taborder("316");
            obj.set_cssclass("sta_WFDA_Data");
            obj.style.set_background("#ffffffff");
            this.div_Data.addChild(obj.name, obj);
            obj = new Static("Static12", "absolute", "0", null, null, "29", "0", "28", this.div_Data);
        ...
        this.loadIncludeScript("Form_Search_Top_Temp3.xfdl", true);
