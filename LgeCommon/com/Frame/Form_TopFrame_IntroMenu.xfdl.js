    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("Form_TopFrame_IntroMenu");
        ...
        // User Script
        this.registerScript("Form_TopFrame_IntroMenu.xfdl", function(exports) {
        /**********************************************************************************************
        * SYSTEM      : 
        * BUSINESS    : 
        * FILE NAME   : Form_TopFrame_IntroMenu.xfdl
        * PROGRAMMER  : 
        * DATE        : 2018-04-19
        * DESCRIPTION : Top 화면
        *----------------------------------------------------------------------------------------------
        ...
        ***********************************************************************************************/
        ...
        this.loadIncludeScript("Form_TopFrame_IntroMenu.xfdl", true);
