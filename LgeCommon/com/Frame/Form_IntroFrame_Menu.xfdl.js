    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("Form_IntroFrame_Menu");
        ...
        // User Script
        this.registerScript("Form_IntroFrame_Menu.xfdl", function(exports) {
        /**********************************************************************************************
        * SYSTEM      : 
        * BUSINESS    : 
        ...
        ***********************************************************************************************/
        ...
        this.Form_IntroFrame_Menu_onload = function(obj,e)
        {
        ...
        this.fn_setRootMenu = function ()
        {
        	...
        	for (var i=0; i<nCnt; i++)
        	{
        		...
        		this.fn_createMenuDataset("ds_" + sRootId, sRootId);	// create_munu_dataset
        	}
        }
        ...
        this.fn_getMaxMenuCount = function()
        {
        	...
        	{
        		// 그리드의 Row 수
        		nRowCnt = this.ds_menu.getCaseCount("ROOT_MENU_ID == '" + this.ds_dump.getColumn(i,"ROOT_MENU_ID") + "'")
        		
        		if (this.fv_maxRowCount < nRowCnt)
        		{
        			this.fv_maxRowCount = nRowCnt;
        		}		
        	}
        	...
        	this.fn_createMenu();	// create_menu
        }
        ...
        this.fn_createMenu = function()
        {
        	...
        	for (var i=0; i<nCnt; i++) 
        	{
        		...
        		comp.addEventHandler("oncellclick", this._fn_menuOncellclick, this);	// menu_event	
        		comp.show();
        		comps.push(comp);
        ...
        {
            this.addEventHandler("onload", this.Form_IntroFrame_Menu_onload, this);

        };

        this.loadIncludeScript("Form_IntroFrame_Menu.xfdl", true);
