    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("Form_Basic_Comp4");
            ...
            obj = new Dataset("ds_popupMenu1", this);
            obj.set_firefirstcount("0");
            obj.getSetter("firenextcount").set("0");
            obj.set_useclientlayout("false");
            obj.set_updatecontrol("true");
            ...
            obj.set_taborder("2");
            obj.set_text("PopupMenu / GroupBox / ProgressBar/ Menu/ FileUp/Download");
            ...
            obj.style.setStyleValue("color", "disabled", "darkgray");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_Popup", "absolute", "11.52%", "69", null, "21", "78.76%", null, this);
            obj.set_taborder("11");
            obj.set_text("PopupMenu");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_Progress", "absolute", "409", "311", "120", "21", null, null, this);
            obj.set_taborder("20");
            ...
            this.addChild(obj.name, obj);
            obj.set_innerdataset("@ds_popupMenu");
            ...
            obj = new PopupMenu("PopupMenu03", "absolute", "42.48%", "69", "170", "112", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_innerdataset("@ds_popupMenu1");
            obj.set_idcolumn("idx");
            obj.set_captioncolumn("Caption");
            obj.set_levelcolumn("lev");
            obj.set_enablecolumn("enable");
            ...
            obj = new Button("btn_Popup1", "absolute", "29.17%", "72", null, "21", "61.11%", null, this);
            obj.set_taborder("24");
            obj.set_text("PopupMenu1");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("Form_Basic_Comp4.xfdl", function(exports) {

        this.btn_Popup_onclick = function(obj,e)
        {
        	var nX   = system.clientToScreenX(obj, 0) - system.clientToScreenX(application.mainframe, 0);
            var nY   = system.clientToScreenY(obj, nexacro.toNumber(obj.height)) - system.clientToScreenY(application.mainframe, 0);
            trace("nX : " + nX);
            trace("nY : " + nY);
        ...
        this.btn_Popup1_onclick = function(obj,e)
        {
        	this.PopupMenu03.trackPopupByComponent(obj, 0, nexacro.toNumber(obj.height));
        }

        this.btn_Progress_onclick = function(obj,e)
        {
        	var i, j;
        ...
        this.on_initEvent = function()
        {
            ...
            this.btn_Progress.addEventHandler("onclick", this.btn_Progress_onclick, this);
            this.PopupMenu01.addEventHandler("onmenuclick", this.PopupMenu00_onmenuclick, this);
            this.btn_Popup1.addEventHandler("onclick", this.btn_Popup1_onclick, this);

        };

        this.loadIncludeScript("Form_Basic_Comp4.xfdl", true);
