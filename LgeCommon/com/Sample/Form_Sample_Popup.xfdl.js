    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("Form_Sample_Popup");
                this.set_titletext("Sample");
                this._setFormPosition(0,0,1224,534);
            }
            ...
            obj = new Grid("grd_Popup", "absolute", "0", "447", null, null, "0", "7", this);
            obj.set_taborder("0");
            ...
            obj = new Static("Static14", "absolute", "0", "293", "143", "151", null, null, this);
            obj.set_taborder("18");
            obj.set_text("exercise");
            obj.set_cssclass("sta_WFDA_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static15", "absolute", "142", "293", null, "151", "0", null, this);
            obj.set_taborder("19");
            obj.set_text("var sDivCd \t= this.ds_grid.getColumn(e.row,\"DIV_CD\");\r\nvar sOption \t= \"modaless=false, autosize=true,resizable=false\";\r\nLGE.Core.popup(this,\"sample_popup\",\"Sample::Form_Sample_Popup_Sub.xfdl\",{argDivCd:sDivCd}, sOption, function (sId, sResult) \r\n{\r\n\tvar aResult = sResult.split(\",\");\r\n\tif(aResult[0] == \"OK\")\r\n\t{\r\n\t\tthis.alert(aResult[1]);\r\n\t}\r\n});");
            obj.set_cssclass("sta_WFDA_Data");
            obj.style.set_font("antialias 9 arial");
            this.addChild(obj.name, obj);
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 1224, 534, this,
            	//-- Layout function
            	function(p) {
        ...
        // User Script
        this.addIncludeScript("Form_Sample_Popup.xfdl", "CommonLibrary::Comm.xjs");
        this.registerScript("Form_Sample_Popup.xfdl", function(exports) {

        // Library Include
        if (this.executeIncludeScript) { this.executeIncludeScript("CommonLibrary::Comm.xjs", null, exports); }	//include "CommonLibrary::Comm.xjs";

        // Form onload
        this.Form_Sample_Popup_onload = function(obj,e)
        {
        	this.com_fromInit(obj);
        }

        this.grd_Popup_oncellclick = function(obj,e)
        {
        	if (e.cell == 6)
        	{
        		var sDivCd 		= this.ds_grid.getColumn(e.row,"DIV_CD");
        		var sOption 	= "modaless=false, autosize=true,resizable=false";
        		LGE.Core.popup(this,"sample_popup","Sample::Form_Sample_Popup_Sub.xfdl",{argDivCd:sDivCd}, sOption, function (sId, sResult) 
        			{
        				var aResult = sResult.split(",");
        ...
        {
            this.grd_Popup.addEventHandler("oncellclick", this.grd_Popup_oncellclick, this);

        };

        this.loadIncludeScript("Form_Sample_Popup.xfdl", true);
