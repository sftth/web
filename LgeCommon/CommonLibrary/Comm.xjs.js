...
(function()
{
    return function(path)
    {
        ...
        this.com_fromInit = function(objForm)
        {
        	...
        	if (objForm["div_Search"])
        	{
        		nSearchHeight = this.div_Search.height;
        	}
        ...
        this._findLanguage = function(sKeyLang)
        {
        	...
        	var nRow = application.gds_language.findRow("WORD_CD", sKeyLang);
        	
        	if(nRow < 0) {
        		trace("not language : " + sKeyLang);
        		return sKeyLang;
        	} else {
        		sChangeLang = application.gds_language.getColumn(nRow, "WORD_TRAN");
        		return sChangeLang;
        	}
        }
