...
(function()
{
    return function(path)
    {
        ...
        this.scriptRootUrl = application.services["host"].url + "rMateChartH5";
        this.htmlUrl = this.scriptRootUrl + "/nexacroChartH5Sample.html";
        ...
        {
        	if (chartObj._ifrm_elem._plugin_object) 
        	{ 	// Runtime
        ...
        this.rMateChart_DocumentComplete = function(obj,e) 
        {
        	...
        	if (obj._ifrm_elem._plugin_object) 
        	{	// Runtime
