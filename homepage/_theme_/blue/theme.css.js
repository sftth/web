...
(function() {
  return function() {
    ...
    this._addCss("EditControl", "accessibility", obj, ["normal"]);
    this._addCss("TextArea", "accessibility", obj, ["normal"]);
    this._addCss("TextAreaControl", "accessibility", obj, ["normal"]);
    this._addCss("MaskEdit", "accessibility", obj, ["normal"]);
    this._addCss("MaskEditControl", "accessibility", obj, ["normal"]);
    ...
    this._addCss("Combo>#comboedit", "accessibility", obj, ["normal"]);
    this._addCss("Combo>#dropbutton", "accessibility", obj, ["normal"]);
    this._addCss("ComboControl", "accessibility", obj, ["normal"]);
    this._addCss("ComboControl>#comboedit", "accessibility", obj, ["normal"]);
    ...
    this._addCss("Calendar>#dropbutton", "accessibility", obj, ["normal", "readonly"]);
    ...
    this._addCss("CalendarControl>#dropbutton", "accessibility", obj, ["normal", "readonly"]);
    ...
    this._addCss("Grid>#controlcombo>#comboedit", "accessibility", obj, ["normal"]);
    ...
    this._addCss("Grid>#controlcalendar>#dropbutton", "accessibility", obj, ["normal", "readonly"]);
    ...
    this._addCss("GridControl>#summary", "accessibility", obj, ["normal"]);
    this._addCss("GridControl>#resizebutton", "accessibility", obj, ["normal"]);
    this._addCss("GridControl>#controledit", "accessibility", obj, ["normal"]);
    this._addCss("GridControl>#controlmaskedit", "accessibility", obj, ["normal"]);
    this._addCss("GridControl>#controltextarea", "accessibility", obj, ["normal"]);
    this._addCss("GridControl>#controlcheckbox", "accessibility", obj, ["normal"]);
    this._addCss("GridControl>#controlcombo", "accessibility", obj, ["normal"]);
    this._addCss("GridControl>#controlcombo>#comboedit", "accessibility", obj, ["normal"]);
    ...
    this._addCss("GridControl>#controlcalendar>#dropbutton", "accessibility", obj, ["normal", "readonly"]);
    ...
    this._addCss("Tab", "accessibility", obj, ["mouseover"]);
    ...
    obj = new nexacro.Style_background("#235798ff","","","0","0","0","0","true");
    ...
    this._addCss("Combo", "color", obj, ["selected"]);
    this._addCss("ComboControl", "color", obj, ["selected"]);
    this._addCss("PopupMenu", "color", obj, ["selected"]);
    this._addCss("PopupMenuControl", "color", obj, ["selected"]);
    ...
    this._addCss("Calendar>#dropbutton", "font", obj, ["normal", "readonly"]);
    ...
    this._addCss("CalendarControl>#dropbutton", "font", obj, ["normal", "readonly"]);
    ...
    this._addCss("Grid>#controlcalendar>#dropbutton", "font", obj, ["normal", "readonly"]);
    ...
    this._addCss("GridControl>#resizebutton", "font", obj, ["normal"]);
    this._addCss("GridControl>#controledit", "font", obj, ["normal"]);
    this._addCss("GridControl>#controlmaskedit", "font", obj, ["normal"]);
    this._addCss("GridControl>#controltextarea", "font", obj, ["normal"]);
    this._addCss("GridControl>#controlcheckbox", "font", obj, ["normal"]);
    this._addCss("GridControl>#controlcombo", "font", obj, ["normal"]);
    this._addCss("GridControl>#controlcombo>#comboedit", "font", obj, ["normal"]);
    ...
    this._addCss("GridControl>#controlcalendar>#dropbutton", "font", obj, ["normal", "readonly"]);
    ...
    this._addCss("EditControl", "gradation", obj, ["normal"]);
    this._addCss("TextArea", "gradation", obj, ["normal"]);
    this._addCss("TextAreaControl", "gradation", obj, ["normal"]);
    this._addCss("MaskEdit", "gradation", obj, ["normal"]);
    this._addCss("MaskEditControl", "gradation", obj, ["normal"]);
    ...
    this._addCss("ComboControl>#comboedit", "gradation", obj, ["normal"]);
    ...
    this._addCss("GridControl>#summary", "gradation", obj, ["normal"]);
    this._addCss("GridControl>#controledit", "gradation", obj, ["normal"]);
    this._addCss("GridControl>#controlmaskedit", "gradation", obj, ["normal"]);
    this._addCss("GridControl>#controltextarea", "gradation", obj, ["normal"]);
    this._addCss("GridControl>#controlcheckbox", "gradation", obj, ["normal"]);
    this._addCss("GridControl>#controlcombo>#comboedit", "gradation", obj, ["normal"]);
    ...
    this._addCss("ComboControl", "opacity", obj, ["normal"]);
    this._addCss("ComboControl>#comboedit", "opacity", obj, ["normal"]);
    ...
    this._addCss("Calendar>#dropbutton", "opacity", obj, ["normal", "readonly"]);
    ...
    this._addCss("CalendarControl>#dropbutton", "opacity", obj, ["normal", "readonly"]);
    ...
    this._addCss("Grid>#controlcalendar>#dropbutton", "opacity", obj, ["normal", "readonly"]);
    ...
    this._addCss("GridControl>#resizebutton", "opacity", obj, ["normal"]);
    this._addCss("GridControl>#controledit", "opacity", obj, ["normal"]);
    this._addCss("GridControl>#controlmaskedit", "opacity", obj, ["normal"]);
    this._addCss("GridControl>#controltextarea", "opacity", obj, ["normal"]);
    this._addCss("GridControl>#controlcheckbox", "opacity", obj, ["normal"]);
    this._addCss("GridControl>#controlcombo", "opacity", obj, ["normal"]);
    this._addCss("GridControl>#controlcombo>#comboedit", "opacity", obj, ["normal"]);
    ...
    this._addCss("GridControl>#controlcalendar>#dropbutton", "opacity", obj, ["normal", "readonly"]);
    ...
    obj = new nexacro.Style_border("2","solid","#6894ccff","");
    ...
    this._addCss("GridControl>#controltextarea", "align", obj, ["normal"]);
    ...
    this._addCss("MaskEditControl", "border", obj, ["mouseover", "disabled"]);
    this._addCss("MaskEdiControlt", "border", obj, ["focused"]);
    this._addCss("Spin>#spinedit", "border", obj, ["normal", "mouseover", "disable", "focused", "selected"]);
    this._addCss("Spin>#spinupbutton", "border", obj, ["disabled"]);
    this._addCss("Spin>#spindownbutton", "border", obj, ["disabled"]);
    this._addCss("SpinControl>#spinedit", "border", obj, ["normal", "mouseover", "disable", "focused", "selected"]);
    this._addCss("SpinControl>#spinupbutton", "border", obj, ["disabled"]);
    this._addCss("SpinControl>#spindownbutton", "border", obj, ["disabled"]);
    this._addCss("Combo>#comboedit", "border", obj, ["normal", "mouseover", "focused", "selected", "disabled", "readonly"]);
    this._addCss("Combo>#dropbutton", "border", obj, ["normal", "pushed", "focused", "disabled", "readonly"]);
    this._addCss("ComboControl>#comboedit", "border", obj, ["normal", "mouseover", "selected", "disabled", "readonly"]);
    this._addCss("ComboControl#comboedit", "border", obj, ["focused"]);
    this._addCss("ComboControl>#dropbutton", "border", obj, ["normal", "mouseover", "pushed", "disabled", "readonly"]);
    this._addCss("Radio", "border", obj, ["normal"]);
    this._addCss("RadioControl", "border", obj, ["normal"]);
    this._addCss("CheckBox", "border", obj, ["normal", "focused", "pushed"]);
    this._addCss("CheckBoxControl", "border", obj, ["normal", "focused", "pushed"]);
    ...
    this._addCss("Calendar>#calendaredit", "border", obj, ["normal", "disabled", "focused", "mouseover", "readonly"]);
    this._addCss("Calendar>#dropbutton", "border", obj, ["normal", "readonly", "mouseover", "focused", "pushed", "disabled"]);
    ...
    this._addCss("CalendarControl>#calendaredit", "border", obj, ["normal", "disabled", "focused", "mouseover", "readonly"]);
    this._addCss("CalendarControl>#dropbutton", "border", obj, ["normal", "readonly", "mouseover", "focused", "pushed", "disabled"]);
    ...
    this._addCss("Grid>#controlcheckbox", "border", obj, ["normal", "focused", "pushed"]);
    this._addCss("Grid>#controlcombo>#comboedit", "border", obj, ["normal", "mouseover", "focused", "selected", "disabled", "readonly"]);
    this._addCss("Grid>#controlcombo>#dropbutton", "border", obj, ["normal", "pushed", "focused", "disabled", "readonly"]);
    this._addCss("Grid>#controlcalendar>#calendaredit", "border", obj, ["normal", "disabled", "focused", "mouseover", "readonly"]);
    this._addCss("Grid>#controlcalendar>#dropbutton", "border", obj, ["normal", "readonly", "mouseover", "focused", "pushed", "disabled"]);
    ...
    this._addCss("GridControl>#controlcheckbox", "border", obj, ["normal", "focused", "pushed"]);
    this._addCss("GridControl>#controlcombo>#comboedit", "border", obj, ["normal", "mouseover", "focused", "selected", "disabled", "readonly"]);
    this._addCss("GridControl>#controlcombo>#dropbutton", "border", obj, ["normal", "pushed", "focused", "disabled", "readonly"]);
    this._addCss("GridControl>#controlcalendar>#calendaredit", "border", obj, ["normal", "disabled", "focused", "mouseover", "readonly"]);
    this._addCss("GridControl>#controlcalendar>#dropbutton", "border", obj, ["normal", "readonly", "mouseover", "focused", "pushed", "disabled"]);
    ...
    this._addCss("Static", "color", obj, ["normal", "disabled"]);
    ...
    this._addCss("Calendar>#dropbutton", "color", obj, ["normal", "readonly"]);
    ...
    this._addCss("CalendarControl>#dropbutton", "color", obj, ["normal", "readonly"]);
    ...
    this._addCss("Grid>#controlcalendar>#dropbutton", "color", obj, ["normal", "readonly"]);
    ...
    this._addCss("GridControl>#resizebutton", "color", obj, ["normal"]);
    this._addCss("GridControl>#controledit", "color", obj, ["normal"]);
    this._addCss("GridControl>#controlcheckbox", "color", obj, ["normal"]);
    this._addCss("GridControl>#controlcombo>#comboedit", "color", obj, ["normal"]);
    ...
    this._addCss("GridControl>#controlcalendar>#dropbutton", "color", obj, ["normal", "readonly"]);
    ...
    this._addCss("TabControl>#spinupbutton", "color", obj, ["normal"]);
    this._addCss("TabControl>#spindownbutton", "color", obj, ["normal"]);
    ...
    this._addCss("CheckBox", "align", obj, ["normal", "focused", "pushed"]);
    this._addCss("CheckBoxControl", "align", obj, ["normal", "focused", "pushed"]);
    ...
    this._addCss("Grid>#controlcheckbox", "align", obj, ["normal", "focused", "pushed"]);
    ...
    this._addCss("GridControl>#controlcheckbox", "align", obj, ["normal", "focused", "pushed"]);
    this._addCss("GridControl>#controlcombo", "align", obj, ["normal"]);
    this._addCss("GridControl>#controlcombo>#comboedit", "align", obj, ["normal"]);
    ...
    this._addCss("Tab>#spinupbutton", "background", obj, ["normal", "disabled"]);
    this._addCss("Tab>#spindownbutton", "background", obj, ["normal", "disabled"]);
    this._addCss("TabControl>#spinupbutton", "background", obj, ["normal", "disabled"]);
    this._addCss("TabControl>#spindownbutton", "background", obj, ["normal", "disabled"]);
    ...
    this._addCss("ComboControl>#comboedit", "cursor", obj, ["normal"]);
    ...
    this._addCss("Calendar>#dropbutton", "cursor", obj, ["normal", "readonly"]);
    ...
    this._addCss("CalendarControl>#dropbutton", "cursor", obj, ["normal", "readonly"]);
    ...
    this._addCss("Grid>#controlcalendar>#dropbutton", "cursor", obj, ["normal", "readonly"]);
    ...
    this._addCss("GridControl>#resizebutton", "cursor", obj, ["normal"]);
    this._addCss("GridControl>#controledit", "cursor", obj, ["normal"]);
    this._addCss("GridControl>#controlmaskedit", "cursor", obj, ["normal"]);
    this._addCss("GridControl>#controltextarea", "cursor", obj, ["normal"]);
    this._addCss("GridControl>#controlcheckbox", "cursor", obj, ["normal"]);
    this._addCss("GridControl>#controlcombo", "cursor", obj, ["normal"]);
    this._addCss("GridControl>#controlcombo>#comboedit", "cursor", obj, ["normal"]);
    ...
    this._addCss("GridControl>#controlcalendar>#dropbutton", "cursor", obj, ["normal", "readonly"]);
    ...
    this._addCss("Tab", "cursor", obj, ["normal", "mouseover"]);
    ...
    this._addCss("ComboControl", "padding", obj, ["normal"]);
    ...
    this._addCss("Calendar>#dropbutton", "padding", obj, ["normal", "readonly"]);
    ...
    this._addCss("CalendarControl>#dropbutton", "padding", obj, ["normal", "readonly"]);
    ...
    this._addCss("Grid>#controlcalendar>#popupcalendar>#monthspin", "padding", obj, ["normal"]);
    this._addCss("GridControl", "padding", obj, ["normal"]);
    this._addCss("GridControl>#resizebutton", "padding", obj, ["normal"]);
    this._addCss("GridControl>#controltextarea", "padding", obj, ["normal"]);
    this._addCss("GridControl>#controlcombo", "padding", obj, ["normal"]);
    this._addCss("GridControl>#controlcombo>#dropbutton", "padding", obj, ["normal"]);
    this._addCss("GridControl>#controlcalendar>#dropbutton", "padding", obj, ["normal", "readonly"]);
    ...
    this._addCss("GridControl>#controlcalendar>#popupcalendar>#monthspin", "padding", obj, ["normal"]);
    ...
    this._addCss("EditControl", "shadow", obj, ["normal"]);
    this._addCss("TextArea", "shadow", obj, ["normal"]);
    this._addCss("TextAreaControl", "shadow", obj, ["normal"]);
    this._addCss("MaskEdit", "shadow", obj, ["normal"]);
    this._addCss("MaskEditControl", "shadow", obj, ["normal"]);
    ...
    this._addCss("ComboControl", "shadow", obj, ["normal"]);
    this._addCss("ComboControl>#comboedit", "shadow", obj, ["normal"]);
    ...
    this._addCss("Calendar>#dropbutton", "shadow", obj, ["normal", "readonly"]);
    ...
    this._addCss("CalendarControl>#dropbutton", "shadow", obj, ["normal", "readonly"]);
    ...
    this._addCss("Grid>#controlcalendar>#dropbutton", "shadow", obj, ["normal", "readonly"]);
    ...
    this._addCss("GridControl>#resizebutton", "shadow", obj, ["normal"]);
    this._addCss("GridControl>#controledit", "shadow", obj, ["normal"]);
    this._addCss("GridControl>#controlmaskedit", "shadow", obj, ["normal"]);
    this._addCss("GridControl>#controltextarea", "shadow", obj, ["normal"]);
    this._addCss("GridControl>#controlcheckbox", "shadow", obj, ["normal"]);
    this._addCss("GridControl>#controlcombo", "shadow", obj, ["normal"]);
    this._addCss("GridControl>#controlcombo>#comboedit", "shadow", obj, ["normal"]);
    ...
    this._addCss("GridControl>#controlcalendar>#dropbutton", "shadow", obj, ["normal", "readonly"]);
    ...
    this._addCss("Calendar>#dropbutton", "align", obj, ["normal", "readonly"]);
    ...
    this._addCss("CalendarControl>#dropbutton", "align", obj, ["normal", "readonly"]);
    ...
    this._addCss("Grid>#controlcalendar>#dropbutton", "align", obj, ["normal", "readonly"]);
    ...
    this._addCss("GridControl>#controlcalendar>#dropbutton", "align", obj, ["normal", "readonly"]);
    ...
    obj = new nexacro.Style_background("","theme://images/btn_Titlebar_min.png","","0","0","0","0","true");
    ...
    this._addCss("Calendar>#dropbutton", "bordertype", obj, ["normal", "readonly"]);
    ...
    this._addCss("CalendarControl>#dropbutton", "bordertype", obj, ["normal", "readonly"]);
    ...
    this._addCss("Grid>#controlcalendar>#dropbutton", "bordertype", obj, ["normal", "readonly"]);
    ...
    this._addCss("GridControl>#summary", "bordertype", obj, ["normal"]);
    this._addCss("GridControl>#controltextarea", "bordertype", obj, ["normal"]);
    ...
    this._addCss("GridControl>#controlcalendar>#dropbutton", "bordertype", obj, ["normal", "readonly"]);
    ...
    this._addCss("GridControl>#resizebutton", "image", obj, ["normal"]);
    ...
    this._addCss("GridControl>#resizebutton", "imagealign", obj, ["normal"]);

    obj = new nexacro.Style_background("","theme://images/btn_Titlebar_min_O.png","","0","0","0","0","true");
    this._addCss("TitleBarControl>#minbutton", "background", obj, ["mouseover"]);

    obj = new nexacro.Style_background("","theme://images/btn_Titlebar_min_P.png","","0","0","0","0","true");
    this._addCss("TitleBarControl>#minbutton", "background", obj, ["pushed"]);

    obj = new nexacro.Style_background("","theme://images/btn_Titlebar_max.png","","0","0","0","0","true");
    this._addCss("TitleBarControl>#maxbutton", "background", obj, ["normal"]);

    obj = new nexacro.Style_background("","theme://images/btn_Titlebar_max_O.png","","0","0","0","0","true");
    this._addCss("TitleBarControl>#maxbutton", "background", obj, ["mouseover"]);

    obj = new nexacro.Style_background("","theme://images/btn_Titlebar_max_P.png","","0","0","0","0","true");
    this._addCss("TitleBarControl>#maxbutton", "background", obj, ["pushed"]);

    obj = new nexacro.Style_background("","theme://images/btn_Titlebar_normal.png","","0","0","0","0","true");
    this._addCss("TitleBarControl>#normalbutton", "background", obj, ["normal"]);

    obj = new nexacro.Style_background("","theme://images/btn_Titlebar_normal_O.png","","0","0","0","0","true");
    this._addCss("TitleBarControl>#normalbutton", "background", obj, ["mouseover"]);

    obj = new nexacro.Style_background("","theme://images/btn_Titlebar_normal_P.png","","0","0","0","0","true");
    this._addCss("TitleBarControl>#normalbutton", "background", obj, ["pushed"]);

    obj = new nexacro.Style_background("","theme://images/btn_Titlebar_close.png","","0","0","0","0","true");
    this._addCss("TitleBarControl>#closebutton", "background", obj, ["normal"]);

    obj = new nexacro.Style_background("","theme://images/btn_Titlebar_close_O.png","","0","0","0","0","true");
    this._addCss("TitleBarControl>#closebutton", "background", obj, ["mouseover"]);

    obj = new nexacro.Style_background("","theme://images/btn_Titlebar_close_P.png","","0","0","0","0","true");
    ...
    this._addCss("HScrollBar>#trackbar", "background", obj, ["normal", "mouseover"]);
    ...
    this._addCss("HScrollBarControl>#trackbar", "background", obj, ["normal", "mouseover"]);
    ...
    this._addCss("MaskEdiControlt", "background", obj, ["focused"]);
    this._addCss("Button", "background", obj, ["normal"]);
    this._addCss("ButtonControl", "background", obj, ["normal"]);
    this._addCss("Spin", "background", obj, ["normal", "mouseover", "focused", "pushed"]);
    ...
    this._addCss("Combo", "background", obj, ["normal", "mouseover", "focused"]);
    this._addCss("Combo>#comboedit", "background", obj, ["normal", "mouseover", "focused", "selected"]);
    this._addCss("Combo>#dropbutton", "background", obj, ["normal"]);
    this._addCss("ComboControl", "background", obj, ["normal", "mouseover", "focused"]);
    this._addCss("ComboControl>#comboedit", "background", obj, ["normal", "mouseover", "selected"]);
    this._addCss("ComboControl#comboedit", "background", obj, ["focused"]);
    this._addCss("ComboControl>#dropbutton", "background", obj, ["normal"]);
    this._addCss("Calendar", "background", obj, ["normal", "mouseover", "focused", "selected"]);
    this._addCss("Calendar>#calendaredit", "background", obj, ["normal"]);
    this._addCss("Calendar>#dropbutton", "background", obj, ["normal", "readonly", "mouseover", "pushed"]);
    this._addCss("Calendar>#spinupbutton", "background", obj, ["normal"]);
    this._addCss("Calendar>#spindownbutton", "background", obj, ["normal"]);
    this._addCss("CalendarControl", "background", obj, ["normal", "mouseover", "focused", "selected"]);
    this._addCss("CalendarControl>#calendaredit", "background", obj, ["normal"]);
    this._addCss("CalendarControl>#dropbutton", "background", obj, ["normal", "readonly", "mouseover", "pushed"]);
    ...
    this._addCss("Grid>#controlcombo", "background", obj, ["normal", "mouseover", "focused"]);
    this._addCss("Grid>#controlcombo>#comboedit", "background", obj, ["normal", "mouseover", "focused", "selected"]);
    this._addCss("Grid>#controlcombo>#dropbutton", "background", obj, ["normal"]);
    this._addCss("Grid>#controlcalendar", "background", obj, ["normal", "mouseover", "focused", "selected"]);
    this._addCss("Grid>#controlcalendar>#calendaredit", "background", obj, ["normal"]);
    this._addCss("Grid>#controlcalendar>#dropbutton", "background", obj, ["normal", "readonly", "mouseover", "pushed"]);
    ...
    this._addCss("GridControl>#controledit", "background", obj, ["normal", "mouseover", "focused"]);
    this._addCss("GridControl>#controlmaskedit", "background", obj, ["normal", "mouseover", "focused"]);
    this._addCss("GridControl>#controltextarea", "background", obj, ["normal"]);
    this._addCss("GridControl>#controlcombo", "background", obj, ["normal", "mouseover", "focused"]);
    this._addCss("GridControl>#controlcombo>#comboedit", "background", obj, ["normal", "mouseover", "focused", "selected"]);
    this._addCss("GridControl>#controlcombo>#dropbutton", "background", obj, ["normal"]);
    this._addCss("GridControl>#controlcalendar", "background", obj, ["normal", "mouseover", "focused", "selected"]);
    this._addCss("GridControl>#controlcalendar>#calendaredit", "background", obj, ["normal"]);
    this._addCss("GridControl>#controlcalendar>#dropbutton", "background", obj, ["normal", "readonly", "mouseover", "pushed"]);
    this._addCss("GridControl>#controlcalendar>#spinupbutton", "background", obj, ["normal"]);
    this._addCss("GridControl>#controlcalendar>#spindownbutton", "background", obj, ["normal"]);
    ...
    obj = new nexacro.Style_border("1","solid","#9b9b9bff","","0","none","","","0","none","","","0","none","","");
    ...
    this._addCss("ComboControl>#comboedit", "bordertype", obj, ["normal"]);
    ...
    this._addCss("GridControl>#controlmaskedit", "bordertype", obj, ["normal"]);
    this._addCss("GridControl>#controlcombo", "bordertype", obj, ["normal"]);
    this._addCss("GridControl>#controlcombo>#comboedit", "bordertype", obj, ["normal"]);
    ...
    this._addCss("MaskEditControl", "color", obj, ["readonly"]);
    this._addCss("Spin", "color", obj, ["readonly"]);
    this._addCss("Combo>#comboedit", "color", obj, ["readonly"]);
    this._addCss("ComboControl>#comboedit", "color", obj, ["readonly"]);
    this._addCss("Calendar", "color", obj, ["readonly"]);
    this._addCss("CalendarControl", "color", obj, ["readonly"]);
    this._addCss("Grid>#controledit", "color", obj, ["readonly"]);
    this._addCss("Grid>#controlmaskedit", "color", obj, ["readonly"]);
    this._addCss("Grid>#controltextarea", "color", obj, ["readonly"]);
    this._addCss("Grid>#controlcombo>#comboedit", "color", obj, ["readonly"]);
    this._addCss("Grid>#controlcalendar", "color", obj, ["readonly"]);
    this._addCss("GridControl>#controledit", "color", obj, ["readonly"]);
    this._addCss("GridControl>#controlmaskedit", "color", obj, ["readonly"]);
    this._addCss("GridControl>#controltextarea", "color", obj, ["readonly"]);
    this._addCss("GridControl>#controlcombo>#comboedit", "color", obj, ["readonly"]);
    this._addCss("GridControl>#controlcalendar", "color", obj, ["readonly"]);
    ...
    obj = new nexacro.Style_gradation("linear 0,0 #f2f6f9 0,100 #f6f6f6 [45% #e6edef][50% #e6edef]");
    this._addCss("StatusBarControl", "gradation", obj, ["normal"]);

    obj = new nexacro.Style_value("theme://images/ico_gripImg.png");
    ...
    this._addCss("GridControl>#resizebutton", "align", obj, ["normal"]);
    ...
    obj = new nexacro.Style_background("#f7f7f7ff","theme://images/progress_bg_N.png","repeat-x","0","0","50","50","true");
    ...
    obj = new nexacro.Style_value("theme://images/progress_end.png");
    this._addCss("StatusBarControl>#progressbar", "endimage", obj, ["normal"]);

    obj = new nexacro.Style_value("theme://images/progress_barbg_N.png");
    this._addCss("StatusBarControl>#progressbar", "progressimage", obj, ["normal"]);

    obj = new nexacro.Style_shadow("drop 1,1 1 #ffffff");
    ...
    obj = new nexacro.Style_value("theme://images/progress_start.png");
    ...
    obj = new nexacro.Style_border("0","solid","#b2bbc3ff","","0","solid","#b2bbc3ff","","0","solid","#b2bbc3ff","","1","solid","#b2bbc3ff","");
    ...
    this._addCss("SpinControl>#spinupbutton", "opacity", obj, ["disabled"]);
    this._addCss("SpinControl>#spindownbutton", "opacity", obj, ["disabled"]);
    ...
    this._addCss("VScrollBar>#incbutton", "image", obj, ["normal", "mouseover", "pushed"]);
    this._addCss("VScrollBarControl>#incbutton", "image", obj, ["normal", "mouseover", "pushed"]);
    ...
    this._addCss("CheckBox", "padding", obj, ["normal", "focused", "pushed"]);
    this._addCss("CheckBoxControl", "padding", obj, ["normal", "focused", "pushed"]);
    ...
    this._addCss("Grid>#controlcheckbox", "padding", obj, ["normal", "focused", "pushed"]);
    this._addCss("Grid>#controlcalendar", "padding", obj, ["normal"]);
    this._addCss("GridControl>#controlcheckbox", "padding", obj, ["normal", "focused", "pushed"]);
    ...
    obj = new nexacro.Style_value("theme://images/btn_vinc_D.png");
    ...
    this._addCss("VScrollBar>#decbutton", "image", obj, ["normal", "mouseover", "pushed"]);
    this._addCss("VScrollBarControl>#decbutton", "image", obj, ["normal", "mouseover", "pushed"]);
    ...
    this._addCss("GridControl>#controlcalendar>#spinupbutton", "imagealign", obj, ["normal"]);
    this._addCss("GridControl>#controlcalendar>#spindownbutton", "imagealign", obj, ["normal"]);
    ...
    obj = new nexacro.Style_value("theme://images/btn_vdec_D.png");
    this._addCss("VScrollBar>#decbutton", "image", obj, ["disabled"]);
    this._addCss("VScrollBarControl>#decbutton", "image", obj, ["disabled"]);

    obj = new nexacro.Style_gradation("linear 0,0 #e9ebec 80,0 #cfd6dc");
    ...
    obj = new nexacro.Style_value("theme://images/img_vTrack.png");
    this._addCss("VScrollBar>#trackbar", "image", obj, ["normal"]);
    this._addCss("VScrollBarControl>#trackbar", "image", obj, ["normal"]);

    obj = new nexacro.Style_gradation("linear 0,0 #fcfcfd 80,0 #e8eff5");
    ...
    obj = new nexacro.Style_value("theme://images/img_vTrack_P.png");
    this._addCss("VScrollBar>#trackbar", "image", obj, ["pushed"]);
    this._addCss("VScrollBarControl>#trackbar", "image", obj, ["pushed"]);

    obj = new nexacro.Style_border("1","solid","#b2bbc3ff","","0","solid","#b2bbc3ff","","0","solid","#b2bbc3ff","","0","solid","#b2bbc3ff","");
    ...
    this._addCss("HScrollBar>#incbutton", "image", obj, ["normal", "mouseover", "pushed"]);
    this._addCss("HScrollBarControl>#incbutton", "image", obj, ["normal", "mouseover", "pushed"]);
    ...
    obj = new nexacro.Style_value("theme://images/btn_hinc_D.png");
    ...
    this._addCss("HScrollBar>#decbutton", "image", obj, ["normal", "mouseover", "pushed"]);
    ...
    obj = new nexacro.Style_value("theme://images/img_hTrack_p.png");
    ...
    this._addCss("Static", "background", obj, ["normal"]);
    this._addCss("Spin>#spinedit", "background", obj, ["readonly"]);
    this._addCss("Radio", "background", obj, ["normal"]);
    this._addCss("RadioControl", "background", obj, ["normal"]);
    this._addCss("CheckBox", "background", obj, ["normal", "focused", "pushed"]);
    this._addCss("CheckBoxControl", "background", obj, ["normal", "focused", "pushed"]);
    ...
    this._addCss("Calendar>#calendaredit", "background", obj, ["focused", "mouseover", "readonly"]);
    ...
    this._addCss("Calendar>#popupcalendar>#monthspin>#spinedit", "background", obj, ["mouseover", "focused", "selected"]);
    ...
    this._addCss("CalendarControl>#calendaredit", "background", obj, ["focused", "mouseover", "readonly"]);
    ...
    this._addCss("CalendarControl>#popupcalendar>#monthspin>#spinedit", "background", obj, ["mouseover", "focused", "selected"]);
    ...
    this._addCss("Grid>#controlcheckbox", "background", obj, ["normal", "focused", "pushed"]);
    this._addCss("Grid>#controlcalendar>#calendaredit", "background", obj, ["focused", "mouseover", "readonly"]);
    ...
    this._addCss("GridControl>#controlcheckbox", "background", obj, ["normal", "focused", "pushed"]);
    this._addCss("GridControl>#controlcalendar>#calendaredit", "background", obj, ["focused", "mouseover", "readonly"]);
    ...
    this._addCss("Edit", "color", obj, ["mouseover", "focused"]);
    this._addCss("EditControl", "color", obj, ["mouseover", "focused"]);
    this._addCss("TextArea", "color", obj, ["normal"]);
    this._addCss("TextAreaControl", "color", obj, ["normal"]);
    this._addCss("MaskEdit", "color", obj, ["normal", "focused"]);
    this._addCss("MaskEditControl", "color", obj, ["normal"]);
    this._addCss("MaskEdiControlt", "color", obj, ["focused"]);
    this._addCss("Button", "color", obj, ["normal"]);
    this._addCss("ButtonControl", "color", obj, ["normal"]);
    this._addCss("Spin", "color", obj, ["normal", "mouseover", "focused", "pushed"]);
    this._addCss("SpinControl", "color", obj, ["normal", "mouseover", "focused"]);
    this._addCss("Combo", "color", obj, ["normal", "mouseover", "focused"]);
    this._addCss("ComboControl", "color", obj, ["normal", "mouseover", "focused"]);
    ...
    this._addCss("Calendar", "color", obj, ["normal", "mouseover", "focused", "selected"]);
    this._addCss("Calendar>#spinupbutton", "color", obj, ["normal"]);
    this._addCss("CalendarControl", "color", obj, ["normal", "mouseover", "focused", "selected"]);
    this._addCss("CalendarControl>#spinupbutton", "color", obj, ["normal"]);
    this._addCss("Grid>#controledit", "color", obj, ["mouseover", "focused"]);
    this._addCss("Grid>#controlmaskedit", "color", obj, ["normal", "focused"]);
    this._addCss("Grid>#controltextarea", "color", obj, ["normal"]);
    this._addCss("Grid>#controlcombo", "color", obj, ["normal", "mouseover", "focused"]);
    this._addCss("Grid>#controlcalendar", "color", obj, ["normal", "mouseover", "focused", "selected"]);
    this._addCss("Grid>#controlcalendar>#spinupbutton", "color", obj, ["normal"]);
    this._addCss("GridControl>#controledit", "color", obj, ["mouseover", "focused"]);
    this._addCss("GridControl>#controlmaskedit", "color", obj, ["normal", "focused"]);
    this._addCss("GridControl>#controltextarea", "color", obj, ["normal"]);
    this._addCss("GridControl>#controlcombo", "color", obj, ["normal", "mouseover", "focused"]);
    this._addCss("GridControl>#controlcalendar", "color", obj, ["normal", "mouseover", "focused", "selected"]);
    ...
    this._addCss("Grid>#controlcombo", "color", obj, ["readonly"]);
    this._addCss("GridControl>#controlcombo", "color", obj, ["readonly"]);
    ...
    this._addCss("TabControl>#spinupbutton", "border", obj, ["normal", "disabled"]);
    this._addCss("TabControl>#spindownbutton", "border", obj, ["normal", "disabled"]);
    ...
    this._addCss("MaskEdit", "border", obj, ["normal", "disabled"]);
    this._addCss("MaskEditControl", "border", obj, ["normal"]);
    this._addCss("Spin", "border", obj, ["normal", "disabled"]);
    this._addCss("SpinControl", "border", obj, ["normal", "disabled"]);
    ...
    this._addCss("GridControl>#controledit", "border", obj, ["normal", "disabled"]);
    this._addCss("GridControl>#controlmaskedit", "border", obj, ["normal", "disabled"]);
    this._addCss("GridControl>#controltextarea", "border", obj, ["normal", "disabled"]);
    this._addCss("GridControl>#controlcombo", "border", obj, ["normal", "disabled"]);
    this._addCss("GridControl>#controlcalendar", "border", obj, ["normal", "disabled"]);
    ...
    this._addCss("GridControl>#resizebutton", "bordertype", obj, ["normal"]);
    ...
    this._addCss("GridControl>#controlmaskedit", "padding", obj, ["normal"]);
    ...
    this._addCss("GridControl>#body", "selectcolor", obj, ["normal", "mouseover"]);

    obj = new nexacro.Style_gradation("linear 0,0 #f5f5f5 0,100 #f1f1f1 [48% #fbfbfb][53% #f7f7f7]");
    this._addCss("Edit", "gradation", obj, ["mouseover"]);
    this._addCss("EditControl", "gradation", obj, ["mouseover"]);
    this._addCss("TextArea", "gradation", obj, ["mouseover"]);
    this._addCss("TextAreaControl", "gradation", obj, ["mouseover"]);
    this._addCss("MaskEdit", "gradation", obj, ["mouseover"]);
    this._addCss("MaskEditControl", "gradation", obj, ["mouseover"]);
    this._addCss("Spin", "gradation", obj, ["mouseover"]);
    this._addCss("SpinControl", "gradation", obj, ["mouseover"]);
    this._addCss("Combo", "gradation", obj, ["mouseover"]);
    this._addCss("Combo>#comboedit", "gradation", obj, ["mouseover", "focused", "selected"]);
    this._addCss("ComboControl", "gradation", obj, ["mouseover"]);
    this._addCss("ComboControl>#comboedit", "gradation", obj, ["mouseover", "selected"]);
    this._addCss("ComboControl#comboedit", "gradation", obj, ["focused"]);
    this._addCss("Calendar", "gradation", obj, ["mouseover"]);
    this._addCss("CalendarControl", "gradation", obj, ["mouseover"]);
    this._addCss("Grid>#controledit", "gradation", obj, ["mouseover"]);
    this._addCss("Grid>#controlmaskedit", "gradation", obj, ["mouseover"]);
    this._addCss("Grid>#controltextarea", "gradation", obj, ["mouseover"]);
    this._addCss("Grid>#controlcombo", "gradation", obj, ["mouseover"]);
    this._addCss("Grid>#controlcombo>#comboedit", "gradation", obj, ["mouseover", "focused", "selected"]);
    this._addCss("Grid>#controlcalendar", "gradation", obj, ["mouseover"]);
    this._addCss("GridControl>#controledit", "gradation", obj, ["mouseover"]);
    this._addCss("GridControl>#controlmaskedit", "gradation", obj, ["mouseover"]);
    this._addCss("GridControl>#controltextarea", "gradation", obj, ["mouseover"]);
    this._addCss("GridControl>#controlcombo", "gradation", obj, ["mouseover"]);
    this._addCss("GridControl>#controlcombo>#comboedit", "gradation", obj, ["mouseover", "focused", "selected"]);
    this._addCss("GridControl>#controlcalendar", "gradation", obj, ["mouseover"]);

    obj = new nexacro.Style_border("1","solid","#0059cdff","");
    ...
    this._addCss("TextAreaControl", "border", obj, ["focused"]);
    ...
    this._addCss("ComboControl", "border", obj, ["mouseover", "focused"]);
    ...
    this._addCss("CalendarControl", "border", obj, ["mouseover", "focused", "selected"]);
    ...
    this._addCss("GridControl>#controltextarea", "border", obj, ["focused"]);
    this._addCss("GridControl>#controlcombo", "border", obj, ["mouseover", "focused"]);
    this._addCss("GridControl>#controlcalendar", "border", obj, ["mouseover", "focused", "selected"]);

    obj = new nexacro.Style_gradation("linear 0,0 #ebebeb 0,100 #e7e7e7 [30% #fbfbfb][70% #fdfdfd]");
    this._addCss("Edit", "gradation", obj, ["focused"]);
    this._addCss("EditControl", "gradation", obj, ["focused"]);
    this._addCss("TextArea", "gradation", obj, ["focused"]);
    this._addCss("TextAreaControl", "gradation", obj, ["focused"]);
    this._addCss("MaskEdit", "gradation", obj, ["focused"]);
    this._addCss("MaskEdiControlt", "gradation", obj, ["focused"]);
    this._addCss("Spin", "gradation", obj, ["focused", "pushed"]);
    this._addCss("SpinControl", "gradation", obj, ["focused"]);
    this._addCss("Combo", "gradation", obj, ["focused"]);
    this._addCss("ComboControl", "gradation", obj, ["focused"]);
    this._addCss("Calendar", "gradation", obj, ["focused", "selected"]);
    this._addCss("CalendarControl", "gradation", obj, ["focused", "selected"]);
    this._addCss("Grid>#controledit", "gradation", obj, ["focused"]);
    this._addCss("Grid>#controlmaskedit", "gradation", obj, ["focused"]);
    this._addCss("Grid>#controltextarea", "gradation", obj, ["focused"]);
    this._addCss("Grid>#controlcombo", "gradation", obj, ["focused"]);
    this._addCss("Grid>#controlcalendar", "gradation", obj, ["focused", "selected"]);
    this._addCss("GridControl>#controledit", "gradation", obj, ["focused"]);
    this._addCss("GridControl>#controlmaskedit", "gradation", obj, ["focused"]);
    this._addCss("GridControl>#controltextarea", "gradation", obj, ["focused"]);
    this._addCss("GridControl>#controlcombo", "gradation", obj, ["focused"]);
    this._addCss("GridControl>#controlcalendar", "gradation", obj, ["focused", "selected"]);
    ...
    this._addCss("ComboControl>#comboedit", "background", obj, ["disabled"]);
    ...
    this._addCss("GridControl>#controlcombo>#comboedit", "background", obj, ["disabled"]);
    this._addCss("GridControl>#controlcalendar", "background", obj, ["disabled"]);
    ...
    this._addCss("GridControl>#controlcombo>#comboedit", "color", obj, ["disabled"]);
    this._addCss("GridControl>#controlcalendar", "color", obj, ["disabled"]);
    this._addCss("GridControl>#controlcalendar>#calendaredit", "color", obj, ["disabled"]);

    obj = new nexacro.Style_background("#edf3f8ff","","","0","0","0","0","true");
    ...
    this._addCss("MaskEditControl", "background", obj, ["readonly"]);
    this._addCss("Spin", "background", obj, ["readonly"]);
    this._addCss("SpinControl", "background", obj, ["readonly"]);
    this._addCss("Combo>#comboedit", "background", obj, ["readonly"]);
    this._addCss("ComboControl>#comboedit", "background", obj, ["readonly"]);
    ...
    this._addCss("Grid>#controlcombo>#comboedit", "background", obj, ["readonly"]);
    this._addCss("Grid>#controlcalendar", "background", obj, ["readonly"]);
    this._addCss("GridControl>#controledit", "background", obj, ["readonly"]);
    this._addCss("GridControl>#controlmaskedit", "background", obj, ["readonly"]);
    this._addCss("GridControl>#controltextarea", "background", obj, ["readonly"]);
    this._addCss("GridControl>#controlcombo>#comboedit", "background", obj, ["readonly"]);
    this._addCss("GridControl>#controlcalendar", "background", obj, ["readonly"]);

    obj = new nexacro.Style_border("1","solid","#bdd2e1ff","");
    ...
    this._addCss("Grid>#controledit", "border", obj, ["readonly"]);
    ...
    this._addCss("GridControl>#controledit", "border", obj, ["readonly"]);
    this._addCss("GridControl>#controlmaskedit", "border", obj, ["readonly"]);
    this._addCss("GridControl>#controltextarea", "border", obj, ["readonly"]);
    this._addCss("GridControl>#controlcombo", "border", obj, ["readonly"]);
    ...
    this._addCss("GridControl>#controltextarea", "linespace", obj, ["normal"]);
    ...
    this._addCss("GridControl>#controlmaskedit", "align", obj, ["normal"]);

    obj = new nexacro.Style_border("1","solid","#ffffff00","");
    this._addCss("MaskEditControl", "border", obj, ["readonly"]);
    ...
    obj = new nexacro.Style_gradation("linear 0,0 #ecece5 0,100 #e4e4e4");
    this._addCss("Button", "gradation", obj, ["focused", "selected"]);
    this._addCss("ButtonControl", "gradation", obj, ["focused", "selected"]);
    ...
    this._addCss("ButtonControl", "border", obj, ["disabled"]);
    ...
    obj = new nexacro.Style_border("1","solid","#abb1b6ff","");
    ...
    obj = new nexacro.Style_gradation("linear 0,0 #f8f9f9 0,100 #e9e9e9 [47% #f3f3f3][52% #e9e9e9]");
    ...
    this._addCss("CalendarControl>#spinupbutton", "image", obj, ["normal", "focused"]);
    this._addCss("Grid>#controlcalendar>#spinupbutton", "image", obj, ["normal", "focused"]);
    this._addCss("GridControl>#controlcalendar>#spinupbutton", "image", obj, ["normal", "focused"]);

    obj = new nexacro.Style_gradation("linear 0,0 #fffffe 0,100 #fffdf1");
    ...
    this._addCss("CalendarControl>#spinupbutton", "image", obj, ["mouseover"]);
    this._addCss("Grid>#controlcalendar>#spinupbutton", "image", obj, ["mouseover"]);
    this._addCss("GridControl>#controlcalendar>#spinupbutton", "image", obj, ["mouseover"]);

    obj = new nexacro.Style_gradation("linear 0,0 #e3e4e4 0,100 #fbfbfb");
    ...
    this._addCss("CalendarControl>#spinupbutton", "image", obj, ["pushed"]);
    this._addCss("Grid>#controlcalendar>#spinupbutton", "image", obj, ["pushed"]);
    this._addCss("GridControl>#controlcalendar>#spinupbutton", "image", obj, ["pushed"]);
    ...
    this._addCss("Calendar>#dropbutton", "background", obj, ["disabled"]);
    this._addCss("Calendar>#spinupbutton", "background", obj, ["disabled"]);
    this._addCss("Calendar>#spindownbutton", "background", obj, ["disabled"]);
    this._addCss("CalendarControl>#dropbutton", "background", obj, ["disabled"]);
    ...
    this._addCss("Grid>#controlcalendar>#dropbutton", "background", obj, ["disabled"]);
    this._addCss("Grid>#controlcalendar>#spinupbutton", "background", obj, ["disabled"]);
    this._addCss("Grid>#controlcalendar>#spindownbutton", "background", obj, ["disabled"]);
    this._addCss("GridControl>#controlcombo>#dropbutton", "background", obj, ["disabled"]);
    this._addCss("GridControl>#controlcalendar>#dropbutton", "background", obj, ["disabled"]);
    this._addCss("GridControl>#controlcalendar>#spinupbutton", "background", obj, ["disabled"]);
    this._addCss("GridControl>#controlcalendar>#spindownbutton", "background", obj, ["disabled"]);
    ...
    this._addCss("GridControl>#controlcalendar>#spinupbutton", "image", obj, ["disabled"]);

    obj = new nexacro.Style_value("theme://images/btn_spindown_N.png");
    ...
    this._addCss("CalendarControl>#spindownbutton", "image", obj, ["normal", "focused"]);
    this._addCss("Grid>#controlcalendar>#spindownbutton", "image", obj, ["normal", "focused"]);
    this._addCss("GridControl>#controlcalendar>#spindownbutton", "image", obj, ["normal", "focused"]);
    ...
    this._addCss("CalendarControl>#spindownbutton", "image", obj, ["mouseover"]);
    this._addCss("Grid>#controlcalendar>#spindownbutton", "image", obj, ["mouseover"]);
    this._addCss("GridControl>#controlcalendar>#spindownbutton", "image", obj, ["mouseover"]);
    ...
    this._addCss("ComboControl", "itemaccessibility", obj, ["normal"]);
    ...
    this._addCss("GridControl>#controlcombo", "itemaccessibility", obj, ["normal"]);
    ...
    this._addCss("GridControl>#controlcombo", "itembackground", obj, ["normal"]);
    ...
    this._addCss("GridControl>#controlcombo", "itemborder", obj, ["normal"]);
    ...
    this._addCss("ComboControl", "itembordertype", obj, ["normal"]);
    ...
    this._addCss("GridControl>#controlcombo", "itembordertype", obj, ["normal"]);
    ...
    this._addCss("ComboControl", "itemgradation", obj, ["normal"]);
    ...
    this._addCss("GridControl>#controlcombo", "itemgradation", obj, ["normal"]);
    ...
    this._addCss("GridControl>#controlcombo", "itemheight", obj, ["normal"]);
    ...
    this._addCss("GridControl>#controlcombo", "itempadding", obj, ["normal"]);
    ...
    this._addCss("ComboControl", "itembackground", obj, ["selected", "focused"]);
    this._addCss("Grid>#controlcombo", "itembackground", obj, ["focused"]);
    this._addCss("GridControl>#controlcombo", "itembackground", obj, ["focused"]);
    ...
    this._addCss("Combo", "itemgradation", obj, ["selected"]);
    this._addCss("ComboControl", "itemgradation", obj, ["selected"]);
    ...
    this._addCss("Combo", "itemborder", obj, ["selected"]);
    this._addCss("ComboControl", "itemborder", obj, ["selected"]);
    ...
    this._addCss("GridControl>#controlcombo", "background", obj, ["readonly"]);
    ...
    this._addCss("GridControl>#controlcheckbox", "color", obj, ["disabled"]);
    ...
    this._addCss("GridControl>#controlcombo", "buttonsize", obj, ["normal"]);
    this._addCss("GridControl>#controlcalendar", "buttonsize", obj, ["normal"]);

    obj = new nexacro.Style_gradation("linear 0,0 #f5f5f5 0,30 #ffffff");
    this._addCss("Combo", "gradation", obj, ["normal"]);
    this._addCss("ComboControl", "gradation", obj, ["normal"]);
    this._addCss("Grid>#controlcombo", "gradation", obj, ["normal"]);
    this._addCss("GridControl>#controlcombo", "gradation", obj, ["normal"]);
    ...
    this._addCss("GridControl>#controlcombo", "itemcolor", obj, ["normal"]);

    obj = new nexacro.Style_font("");
    this._addCss("Combo", "itemfont", obj, ["normal"]);
    this._addCss("ComboControl", "itemfont", obj, ["normal"]);
    this._addCss("Grid>#controlcombo", "itemfont", obj, ["normal"]);
    this._addCss("GridControl>#controlcombo", "itemfont", obj, ["normal"]);
    ...
    this._addCss("PopupMenu", "itembackground", obj, ["mouseover", "focused"]);
    this._addCss("PopupMenuControl", "itembackground", obj, ["mouseover", "focused"]);

    obj = new nexacro.Style_border("1","solid","#ffffff00","");
    this._addCss("Combo", "itemborder", obj, ["mouseover", "focused"]);
    this._addCss("ComboControl", "itemborder", obj, ["mouseover", "focused"]);
    this._addCss("Grid>#controlcombo", "itemborder", obj, ["mouseover", "focused"]);
    this._addCss("GridControl>#controlcombo", "itemborder", obj, ["mouseover", "focused"]);
    this._addCss("Menu", "itemborder", obj, ["normal"]);
    this._addCss("MenuControl", "itemborder", obj, ["normal"]);

    obj = new nexacro.Style_gradation("linear 0,0 #ff9c28 0,100 #f48501");
    this._addCss("Combo", "itemgradation", obj, ["focused"]);
    this._addCss("ComboControl", "itemgradation", obj, ["focused"]);
    this._addCss("Grid>#controlcombo", "itemgradation", obj, ["focused"]);
    this._addCss("GridControl>#controlcombo", "itemgradation", obj, ["focused"]);

    obj = new nexacro.Style_color("#ffffff");
    this._addCss("Combo", "itemcolor", obj, ["focused"]);
    this._addCss("ComboControl", "itemcolor", obj, ["focused"]);
    this._addCss("Grid>#controlcombo", "itemcolor", obj, ["focused"]);
    this._addCss("GridControl>#controlcombo", "itemcolor", obj, ["focused"]);
    ...
    this._addCss("GridControl>#controlcombo>#comboedit", "padding", obj, ["normal"]);

    obj = new nexacro.Style_gradation("linear 0,0 #ffffff 0,100 #e3e3dd [47% #f2f2f2][52% #e1e1e1]");
    this._addCss("Combo>#dropbutton", "gradation", obj, ["normal"]);
    this._addCss("ComboControl>#dropbutton", "gradation", obj, ["normal"]);
    this._addCss("Calendar>#dropbutton", "gradation", obj, ["normal", "readonly"]);
    this._addCss("CalendarControl>#dropbutton", "gradation", obj, ["normal", "readonly"]);
    this._addCss("Grid>#controlcombo>#dropbutton", "gradation", obj, ["normal"]);
    this._addCss("Grid>#controlcalendar>#dropbutton", "gradation", obj, ["normal", "readonly"]);
    this._addCss("GridControl>#controlcombo>#dropbutton", "gradation", obj, ["normal"]);
    this._addCss("GridControl>#controlcalendar>#dropbutton", "gradation", obj, ["normal", "readonly"]);
    ...
    this._addCss("GridControl>#controlcombo>#dropbutton", "image", obj, ["normal"]);

    obj = new nexacro.Style_gradation("linear 0,0 #ffffff 0,100 #f5f4e9");
    this._addCss("Combo>#dropbutton", "gradation", obj, ["mouseover"]);
    this._addCss("ComboControl>#dropbutton", "gradation", obj, ["mouseover"]);
    this._addCss("Calendar>#dropbutton", "gradation", obj, ["mouseover"]);
    this._addCss("CalendarControl>#dropbutton", "gradation", obj, ["mouseover"]);
    this._addCss("Grid>#controlcombo>#dropbutton", "gradation", obj, ["mouseover"]);
    this._addCss("Grid>#controlcalendar>#dropbutton", "gradation", obj, ["mouseover"]);
    this._addCss("GridControl>#controlcombo>#dropbutton", "gradation", obj, ["mouseover"]);
    this._addCss("GridControl>#controlcalendar>#dropbutton", "gradation", obj, ["mouseover"]);

    obj = new nexacro.Style_value("theme://images/btn_drop_O.png");
    this._addCss("Combo>#dropbutton", "image", obj, ["mouseover"]);
    this._addCss("ComboControl>#dropbutton", "image", obj, ["mouseover"]);
    this._addCss("Grid>#controlcombo>#dropbutton", "image", obj, ["mouseover"]);
    this._addCss("GridControl>#controlcombo>#dropbutton", "image", obj, ["mouseover"]);

    obj = new nexacro.Style_gradation("linear 0,0 #e7e7e7 0,100 #fdfdfd");
    this._addCss("Combo>#dropbutton", "gradation", obj, ["pushed"]);
    this._addCss("ComboControl>#dropbutton", "gradation", obj, ["pushed"]);
    this._addCss("Calendar>#dropbutton", "gradation", obj, ["pushed"]);
    this._addCss("CalendarControl>#dropbutton", "gradation", obj, ["pushed"]);
    this._addCss("Grid>#controlcombo>#dropbutton", "gradation", obj, ["pushed"]);
    this._addCss("Grid>#controlcalendar>#dropbutton", "gradation", obj, ["pushed"]);
    this._addCss("GridControl>#controlcombo>#dropbutton", "gradation", obj, ["pushed"]);
    this._addCss("GridControl>#controlcalendar>#dropbutton", "gradation", obj, ["pushed"]);

    obj = new nexacro.Style_value("theme://images/btn_drop_P.png");
    this._addCss("Combo>#dropbutton", "image", obj, ["pushed"]);
    this._addCss("ComboControl>#dropbutton", "image", obj, ["pushed"]);
    this._addCss("Grid>#controlcombo>#dropbutton", "image", obj, ["pushed"]);
    this._addCss("GridControl>#controlcombo>#dropbutton", "image", obj, ["pushed"]);

    obj = new nexacro.Style_value("theme://images/btn_drop_D.png");
    ...
    this._addCss("GridControl>#controlcombo>#dropbutton", "image", obj, ["disabled"]);

    obj = new nexacro.Style_border("1","solid","#333637ff","");
    this._addCss("ComboControl>#dropbutton", "border", obj, ["focused"]);

    obj = new nexacro.Style_value("left center");
    this._addCss("Radio", "buttonalign", obj, ["normal"]);
    this._addCss("CheckBox", "buttonalign", obj, ["normal", "focused", "pushed"]);

    obj = new nexacro.Style_background("@gradation","","","0","0","0","0","true");
    this._addCss("Radio", "buttonbackground", obj, ["normal"]);
    this._addCss("RadioControl", "buttonbackground", obj, ["normal"]);
    this._addCss("CheckBox", "buttonbackground", obj, ["normal", "mouseover", "focused", "pushed"]);
    this._addCss("CheckBoxControl", "buttonbackground", obj, ["normal", "mouseover", "focused", "pushed"]);
    this._addCss("Step", "buttonbackground", obj, ["normal"]);
    this._addCss("StepControl", "buttonbackground", obj, ["normal"]);
    this._addCss("Grid>#controlcheckbox", "buttonbackground", obj, ["normal", "mouseover", "focused", "pushed"]);
    this._addCss("GridControl>#controlcheckbox", "buttonbackground", obj, ["normal", "mouseover", "focused", "pushed"]);
    this._addCss("Tab", "buttonbackground", obj, ["normal", "mouseover", "selected", "focused"]);
    this._addCss("TabControl", "buttonbackground", obj, ["normal", "mouseover", "selected", "focused"]);
    this._addCss("FileUpload", "buttonbackground", obj, ["normal"]);
    this._addCss("FileUploadControl", "buttonbackground", obj, ["normal"]);

    obj = new nexacro.Style_value("1 solid #a7adb0");
    this._addCss("Radio", "buttonborder", obj, ["normal", "selected"]);

    obj = new nexacro.Style_gradation("linear 0,0 #dae1e4 0,100 #ffffff");
    this._addCss("Radio", "buttongradation", obj, ["normal"]);
    this._addCss("RadioControl", "buttongradation", obj, ["normal"]);
    this._addCss("CheckBox", "buttongradation", obj, ["normal", "focused", "pushed"]);
    this._addCss("CheckBoxControl", "buttongradation", obj, ["normal", "focused", "pushed"]);
    this._addCss("Grid>#controlcheckbox", "buttongradation", obj, ["normal", "focused", "pushed"]);
    this._addCss("GridControl>#controlcheckbox", "buttongradation", obj, ["normal", "focused", "pushed"]);
    ...
    this._addCss("CheckBox", "buttonsize", obj, ["normal", "focused", "pushed"]);
    this._addCss("CheckBoxControl", "buttonsize", obj, ["normal", "focused", "pushed"]);
    this._addCss("Step", "buttonsize", obj, ["normal"]);
    this._addCss("StepControl", "buttonsize", obj, ["normal"]);
    this._addCss("Grid>#controlcheckbox", "buttonsize", obj, ["normal", "focused", "pushed"]);
    this._addCss("GridControl>#controlcheckbox", "buttonsize", obj, ["normal", "focused", "pushed"]);
    ...
    this._addCss("CheckBox", "textpadding", obj, ["normal", "mouseover", "focused", "pushed"]);
    this._addCss("CheckBoxControl", "textpadding", obj, ["normal", "mouseover", "focused", "pushed"]);
    this._addCss("Grid>#controlcheckbox", "textpadding", obj, ["normal", "mouseover", "focused", "pushed"]);
    this._addCss("GridControl>#controlcheckbox", "textpadding", obj, ["normal", "mouseover", "focused", "pushed"]);

    obj = new nexacro.Style_gradation("linear 0,0 #ffffff 0,100 #dae1e4");
    ...
    this._addCss("Grid>#controlcheckbox", "buttongradation", obj, ["mouseover"]);
    this._addCss("GridControl>#controlcheckbox", "buttongradation", obj, ["mouseover"]);

    obj = new nexacro.Style_value("1 solid #0059cd");
    this._addCss("Radio", "buttonborder", obj, ["mouseover"]);

    obj = new nexacro.Style_value("theme://images/btn_radio_S.png");
    this._addCss("Radio", "buttonimage", obj, ["selected"]);
    this._addCss("RadioControl", "buttonimage", obj, ["selected"]);

    obj = new nexacro.Style_value("theme://images/btn_radio_D.png");
    this._addCss("Radio", "buttonimage", obj, ["disabled"]);
    this._addCss("RadioControl", "buttonimage", obj, ["disabled"]);

    obj = new nexacro.Style_value("1 solid #b3bbc3");
    ...
    this._addCss("CheckBoxControl", "buttonalign", obj, ["normal", "focused", "pushed"]);
    this._addCss("Grid>#controlcheckbox", "buttonalign", obj, ["normal", "focused", "pushed"]);
    this._addCss("GridControl>#controlcheckbox", "buttonalign", obj, ["normal", "focused", "pushed"]);

    obj = new nexacro.Style_value("1 solid #a7adb0");
    this._addCss("RadioControl", "buttonborder", obj, ["normal", "selected"]);
    this._addCss("CheckBoxControl", "buttonborder", obj, ["normal", "focused", "pushed"]);
    this._addCss("Grid>#controlcheckbox", "buttonborder", obj, ["normal", "focused", "pushed"]);
    this._addCss("GridControl>#controlcheckbox", "buttonborder", obj, ["normal", "focused", "pushed"]);

    obj = new nexacro.Style_value("1 solid #0059cd");
    this._addCss("RadioControl", "buttonborder", obj, ["mouseover"]);
    this._addCss("CheckBoxControl", "buttonborder", obj, ["mouseover"]);
    this._addCss("Grid>#controlcheckbox", "buttonborder", obj, ["mouseover"]);
    this._addCss("GridControl>#controlcheckbox", "buttonborder", obj, ["mouseover"]);

    obj = new nexacro.Style_value("1 solid #b3bbc3");
    this._addCss("RadioControl", "buttonborder", obj, ["disabled"]);

    obj = new nexacro.Style_value("1 solid #a7adb0");
    this._addCss("CheckBox", "buttonborder", obj, ["normal", "focused", "pushed"]);
    ...
    obj = new nexacro.Style_value("theme://images/img_check_N.png");
    ...
    obj = new nexacro.Style_value("theme://images/img_check_S.png");
    this._addCss("CheckBox", "buttonimage", obj, ["focused", "pushed"]);
    this._addCss("CheckBoxControl", "buttonimage", obj, ["focused", "pushed"]);
    this._addCss("Grid>#controlcheckbox", "buttonimage", obj, ["focused", "pushed"]);
    this._addCss("GridControl>#controlcheckbox", "buttonimage", obj, ["focused", "pushed"]);
    ...
    this._addCss("Grid>#controlcheckbox", "buttongradation", obj, ["disabled"]);
    this._addCss("GridControl>#controlcheckbox", "buttongradation", obj, ["disabled"]);

    obj = new nexacro.Style_value("1 solid #b1c0cb");
    this._addCss("CheckBoxControl", "buttonborder", obj, ["disabled"]);
    this._addCss("Grid>#controlcheckbox", "buttonborder", obj, ["disabled"]);
    this._addCss("GridControl>#controlcheckbox", "buttonborder", obj, ["disabled"]);
    this._addCss("TabControlTabControl", "buttonborder", obj, ["disabled"]);
    ...
    obj = new nexacro.Style_border("1","solid","#1a4a88ff","");
    ...
    obj = new nexacro.Style_color("#1a4a88ff");
    ...
    obj = new nexacro.Style_value("theme://images/img_grouptitle.png");
    ...
    obj = new nexacro.Style_value("theme://images/img_grouptitle_D.png");
    ...
    obj = new nexacro.Style_color("#666666");
    this._addCss("DatePicker", "daycolor", obj, ["normal", "mouseover", "selected"]);
    this._addCss("DatePickerControl", "daycolor", obj, ["normal", "mouseover", "selected"]);
    this._addCss("Calendar", "daycolor", obj, ["normal", "mouseover", "focused", "selected"]);
    this._addCss("CalendarControl", "daycolor", obj, ["normal", "mouseover", "focused", "selected"]);
    this._addCss("Grid>#controlcalendar", "daycolor", obj, ["normal", "mouseover", "focused", "selected"]);
    this._addCss("GridControl>#controlcalendar", "daycolor", obj, ["normal", "mouseover", "focused", "selected"]);
    ...
    this._addCss("Calendar", "dayfont", obj, ["mouseover", "focused", "selected"]);
    this._addCss("CalendarControl", "dayfont", obj, ["mouseover", "focused", "selected"]);
    this._addCss("Grid>#controlcalendar", "dayfont", obj, ["mouseover", "focused", "selected"]);
    this._addCss("GridControl>#controlcalendar", "dayfont", obj, ["mouseover", "focused", "selected"]);
    ...
    obj = new nexacro.Style_gradation("linear 0,0 #f8f8f8 1,100 #e8e8e8");
    ...
    obj = new nexacro.Style_font("12 bold antialias Verdana");
    ...
    obj = new nexacro.Style_background("","theme://images/Cal_weekBg.png","stretch","5","0","0","0","true");
    ...
    obj = new nexacro.Style_background("#ffffffff","","","0","0","0","0","true");
    this._addCss("DatePicker", "saturdaybackground", obj, ["normal", "selected"]);
    this._addCss("DatePickerControl", "saturdaybackground", obj, ["normal", "selected"]);
    ...
    this._addCss("DatePicker", "saturdaycolor", obj, ["normal", "mouseover", "selected"]);
    this._addCss("DatePickerControl", "saturdaycolor", obj, ["normal", "mouseover", "selected"]);

    obj = new nexacro.Style_background("#ffffffff","","","0","0","0","0","true");
    this._addCss("DatePicker", "sundaybackground", obj, ["normal", "selected"]);
    this._addCss("DatePickerControl", "sundaybackground", obj, ["normal", "selected"]);
    ...
    this._addCss("DatePicker", "sundaycolor", obj, ["normal", "mouseover", "selected"]);
    this._addCss("DatePickerControl", "sundaycolor", obj, ["normal", "mouseover", "selected"]);
    ...
    obj = new nexacro.Style_border("1","solid","#ffffbeff","");
    ...
    this._addCss("Grid>#controlcalendar", "dayborder", obj, ["mouseover"]);
    this._addCss("GridControl>#controlcalendar", "dayborder", obj, ["mouseover"]);
    ...
    obj = new nexacro.Style_border("0","none","","");
    this._addCss("DatePicker", "saturdayborder", obj, ["mouseover", "selected"]);
    this._addCss("DatePickerControl", "saturdayborder", obj, ["mouseover", "selected"]);
    ...
    obj = new nexacro.Style_border("0","none","","");
    this._addCss("DatePicker", "sundayborder", obj, ["mouseover", "selected"]);
    this._addCss("DatePickerControl", "sundayborder", obj, ["mouseover", "selected"]);
    ...
    this._addCss("CalendarControl", "daybackground", obj, ["focused", "selected"]);
    this._addCss("Grid>#controlcalendar", "daybackground", obj, ["focused", "selected"]);
    this._addCss("GridControl>#controlcalendar", "daybackground", obj, ["focused", "selected"]);
    ...
    this._addCss("Calendar", "dayborder", obj, ["focused", "selected"]);
    this._addCss("CalendarControl", "dayborder", obj, ["focused", "selected"]);
    this._addCss("Grid>#controlcalendar", "dayborder", obj, ["focused", "selected"]);
    this._addCss("GridControl>#controlcalendar", "dayborder", obj, ["focused", "selected"]);
    ...
    obj = new nexacro.Style_value("156 191");
    ...
    obj = new nexacro.Style_background("#cce9ffff","","","0","0","0","0","true");
    ...
    obj = new nexacro.Style_border("1","solid","#d3dfe8ff","");
    ...
    this._addCss("GridControl>#controlcalendar", "border", obj, ["readonly"]);
    ...
    obj = new nexacro.Style_value("theme://images/btn_CalDrop_N.png");
    this._addCss("Calendar>#dropbutton", "image", obj, ["normal", "readonly", "focused"]);
    this._addCss("CalendarControl>#dropbutton", "image", obj, ["normal", "readonly", "focused"]);
    this._addCss("Grid>#controlcalendar>#dropbutton", "image", obj, ["normal", "readonly", "focused"]);
    this._addCss("GridControl>#controlcalendar>#dropbutton", "image", obj, ["normal", "readonly", "focused"]);

    obj = new nexacro.Style_align("right middle");
    this._addCss("Calendar>#dropbutton", "imagealign", obj, ["normal", "readonly"]);
    this._addCss("CalendarControl>#dropbutton", "imagealign", obj, ["normal", "readonly"]);
    this._addCss("Grid>#controlcalendar>#dropbutton", "imagealign", obj, ["normal", "readonly"]);
    this._addCss("GridControl>#controlcalendar>#dropbutton", "imagealign", obj, ["normal", "readonly"]);

    obj = new nexacro.Style_value("theme://images/btn_CalDrop_D.png");
    ...
    this._addCss("GridControl>#controlcalendar>#dropbutton", "image", obj, ["disabled"]);

    obj = new nexacro.Style_border("1","solid","#acb2b8ff","");
    ...
    this._addCss("Grid>#controlcalendar>#spinupbutton", "border", obj, ["disabled"]);
    this._addCss("Grid>#controlcalendar>#spindownbutton", "border", obj, ["disabled"]);
    this._addCss("GridControl>#controlcalendar>#spinupbutton", "border", obj, ["disabled"]);
    this._addCss("GridControl>#controlcalendar>#spindownbutton", "border", obj, ["disabled"]);

    obj = new nexacro.Style_value("theme://images/btn_spindown_P.png");
    this._addCss("Calendar>#spindownbutton", "image", obj, ["pushed"]);
    this._addCss("CalendarControl>#spindownbutton", "image", obj, ["pushed"]);
    this._addCss("Grid>#controlcalendar>#spindownbutton", "image", obj, ["pushed"]);
    this._addCss("GridControl>#controlcalendar>#spindownbutton", "image", obj, ["pushed"]);

    obj = new nexacro.Style_value("theme://images/btn_prev_N.png");
    ...
    obj = new nexacro.Style_value("theme://images/btn_prev_O.png");
    ...
    this._addCss("GridControl>#controlcalendar>#popupcalendar>#prevbutton", "image", obj, ["mouseover"]);

    obj = new nexacro.Style_value("theme://images/btn_prev_P.png");
    ...
    this._addCss("GridControl>#controlcalendar>#popupcalendar>#prevbutton", "image", obj, ["pushed"]);
    ...
    this._addCss("GridControl>#controlcalendar>#popupcalendar>#prevbutton", "opacity", obj, ["disabled"]);

    obj = new nexacro.Style_value("theme://images/btn_next_N.png");
    ...
    obj = new nexacro.Style_value("theme://images/btn_next_O.png");
    ...
    this._addCss("GridControl>#controlcalendar>#popupcalendar>#nextbutton", "image", obj, ["mouseover"]);

    obj = new nexacro.Style_value("theme://images/btn_next_P.png");
    ...
    this._addCss("GridControl>#controlcalendar>#popupcalendar>#nextbutton", "image", obj, ["pushed"]);
    ...
    obj = new nexacro.Style_value("theme://images/btn_CalSpinUp.png");
    ...
    obj = new nexacro.Style_value("theme://images/btn_CalSpinDown.png");
    ...
    this._addCss("PopupMenu", "color", obj, ["normal", "mouseover", "focused"]);
    this._addCss("PopupMenuControl", "color", obj, ["normal", "mouseover", "focused"]);
    ...
    this._addCss("GridControl>#summary", "selectline", obj, ["normal"]);
    ...
    this._addCss("GridControl>#summary", "selectlinetype", obj, ["normal"]);
    ...
    obj = new nexacro.Style_value("theme://images/ico_treecollapse.png");
    this._addCss("Grid", "treecollapseimage", obj, ["normal"]);
    this._addCss("GridControl", "treecollapseimage", obj, ["normal"]);

    obj = new nexacro.Style_value("theme://images/ico_treeexpand.png");
    ...
    obj = new nexacro.Style_border("1","solid","#0059cdff","","0","none","","","1","solid","#9b9b9bff","","0","none","","");
    ...
    this._addCss("GridControl>#summary", "cellalign", obj, ["normal"]);
    ...
    this._addCss("GridControl>#body", "cellcolor", obj, ["normal"]);
    ...
    this._addCss("GridControl>#body", "cellcolor2", obj, ["normal"]);
    ...
    this._addCss("GridControl>#body", "cellfont", obj, ["normal"]);
    this._addCss("GridControl>#summ", "cellfont", obj, ["normal"]);
    this._addCss("GridControl>#summary", "cellfont", obj, ["normal"]);

    obj = new nexacro.Style_gradation("linear 0,0 #fcfcfc 0,100 #e7e7e7");
    ...
    this._addCss("GridControl>#summary", "celllinespace", obj, ["normal"]);
    ...
    this._addCss("GridControl>#summary", "celllinetype", obj, ["normal"]);
    ...
    this._addCss("GridControl>#summary", "cellpadding", obj, ["normal"]);

    obj = new nexacro.Style_gradation("linear 0,0 #f9f9f8 0,100 #dadad3");
    ...
    this._addCss("GridControl>#summary", "selectbackground", obj, ["normal"]);
    ...
    this._addCss("GridControl>#summary", "selectborder", obj, ["normal"]);
    ...
    this._addCss("GridControl>#summary", "selectcolor", obj, ["normal"]);
    ...
    this._addCss("GridControl>#summary", "selectfont", obj, ["normal"]);
    ...
    this._addCss("GridControl>#summary", "selectgradation", obj, ["normal"]);

    obj = new nexacro.Style_border("0","none","","","1","solid","#e5e5e5ff","","1","solid","#e5e5e5ff","","1","solid","#e5e5e5ff","");
    ...
    this._addCss("GridControl>#body", "cellbackground", obj, ["normal", "disabled"]);
    ...
    this._addCss("GridControl>#summary", "cellgradation", obj, ["normal"]);
    ...
    this._addCss("GridControl>#summary", "cellgradation2", obj, ["normal"]);
    ...
    obj = new nexacro.Style_value("#5d8bc7");
    ...
    obj = new nexacro.Style_background("#d3e3f1ff","","","0","0","0","0","true");
    ...
    obj = new nexacro.Style_color("#55555");
    this._addCss("Grid>#body", "cellcolor", obj, ["mouseover"]);
    this._addCss("GridControl>#body", "cellcolor", obj, ["mouseover"]);

    obj = new nexacro.Style_value("#f7960c");
    this._addCss("Grid>#body", "selectbackground", obj, ["mouseover"]);
    this._addCss("GridControl>#body", "selectbackground", obj, ["mouseover"]);

    obj = new nexacro.Style_background("#e5e5e566","","","0","0","0","0","true");
    this._addCss("Grid>#body", "cellbackground2", obj, ["disabled"]);
    this._addCss("GridControl>#body", "cellbackground2", obj, ["disabled"]);

    obj = new nexacro.Style_color("#6e6e63");
    this._addCss("Grid>#body", "cellcolor", obj, ["disabled"]);
    this._addCss("GridControl>#body", "cellcolor", obj, ["disabled"]);

    obj = new nexacro.Style_value("#ffffff");
    this._addCss("Grid>#body", "selectbackground", obj, ["disabled"]);
    this._addCss("GridControl>#body", "selectbackground", obj, ["disabled"]);

    obj = new nexacro.Style_color("#6e6e63");
    this._addCss("Grid>#body", "selectcolor", obj, ["disabled"]);
    this._addCss("GridControl>#body", "selectcolor", obj, ["disabled"]);

    obj = new nexacro.Style_background("#f6e2c8ff","","","0","0","0","0","true");
    ...
    this._addCss("GridControl>#summary", "background", obj, ["normal"]);

    obj = new nexacro.Style_border("0","none","","","1","solid","#bbbbbbff","","1","solid","#bbbbbbff","","1","solid","#bbbbbbff","");
    ...
    this._addCss("GridControl>#summary", "border", obj, ["normal"]);
    ...
    this._addCss("GridControl>#summary", "cellbackground", obj, ["normal"]);
    ...
    this._addCss("GridControl>#summary", "cellbackground2", obj, ["normal"]);
    ...
    this._addCss("GridControl>#summary", "cellcolor", obj, ["normal"]);
    ...
    this._addCss("GridControl>#summary", "cellcolor2", obj, ["normal"]);
    ...
    this._addCss("GridControl>#summary", "cellline", obj, ["normal"]);
    ...
    this._addCss("GridControl>#resizebutton", "gradation", obj, ["normal"]);
    ...
    this._addCss("Tab", "buttonborder", obj, ["normal", "mouseover", "selected", "focused"]);
    ...
    obj = new nexacro.Style_gradation("liner 0,0 #e4e4e4 0,100 #c3c3c3");
    ...
    obj = new nexacro.Style_gradation("liner 0,0 #f9f9f9 0,100 #d1d1d1");
    this._addCss("Tab", "buttongradation", obj, ["mouseover"]);
    this._addCss("TabControl", "buttongradation", obj, ["mouseover"]);

    obj = new nexacro.Style_padding("");
    this._addCss("Tab", "buttonpadding", obj, ["mouseover"]);
    ...
    obj = new nexacro.Style_value("");
    this._addCss("Tab", "showextrabutton", obj, ["mouseover"]);

    obj = new nexacro.Style_gradation("liner 0,0 #ffffff 0,100 #e9e9e9");
    ...
    this._addCss("TabControlTabControl", "color", obj, ["disabled"]);

    obj = new nexacro.Style_background("#dfe4e8ff","","","0","0","0","0","true");
    this._addCss("Tab", "buttonbackground", obj, ["disabled"]);
    this._addCss("TabControlTabControl", "buttonbackground", obj, ["disabled"]);
    ...
    obj = new nexacro.Style_value("1 solid #a8a8a2");
    this._addCss("TabControl", "buttonborder", obj, ["normal", "mouseover", "selected", "focused"]);

    obj = new nexacro.Style_gradation("linear 0,0 #e9e9e9 0,100 #ffffff");
    this._addCss("Tabpage", "gradation", obj, ["normal"]);

    obj = new nexacro.Style_background("#f5f7f9ff","","","0","0","0","0","true");
    this._addCss("PopupMenu", "background", obj, ["normal"]);
    this._addCss("PopupMenuControl", "background", obj, ["normal"]);

    obj = new nexacro.Style_border("1","solid","#85b5f4ff","");
    ...
    obj = new nexacro.Style_value("theme://images/ico_expand.png");
    ...
    obj = new nexacro.Style_border("1","solid","#f5f7f8ff","","0","none","","");
    this._addCss("PopupMenu", "itemborder", obj, ["normal", "mouseover", "focused"]);
    this._addCss("PopupMenuControl", "itemborder", obj, ["normal", "mouseover", "focused"]);
    ...
    this._addCss("PopupMenu", "itempadding", obj, ["normal", "mouseover", "focused", "selected"]);
    this._addCss("PopupMenuControl", "itempadding", obj, ["normal", "mouseover", "focused", "selected"]);

    obj = new nexacro.Style_padding("0 2 0 2");
    this._addCss("PopupMenu", "padding", obj, ["normal", "mouseover", "focused", "selected"]);
    this._addCss("PopupMenuControl", "padding", obj, ["normal", "mouseover", "focused", "selected"]);
    ...
    obj = new nexacro.Style_background("#f88c0eff","","","0","0","0","0","true");
    this._addCss("PopupMenu", "itembackground", obj, ["selected"]);
    this._addCss("PopupMenuControl", "itembackground", obj, ["selected"]);
    ...
    obj = new nexacro.Style_font("10 bold Dotum");
    this._addCss("Menu", "font", obj, ["normal"]);
    this._addCss("MenuControl", "font", obj, ["normal"]);

    obj = new nexacro.Style_gradation("linear 0,0 #0655a5 0,100 #044e9e");
    ...
    obj = new nexacro.Style_background("","theme://images/img_TP_GNB_GuideLine.png","","0","0","100","50","true");
    ...
    this._addCss("MenuControl", "popupitemborder", obj, ["normal", "mouseover"]);
    ...
    this._addCss("Menu", "itembackground", obj, ["mouseover", "pushed", "selected", "focused"]);
    this._addCss("MenuControl", "itembackground", obj, ["mouseover", "pushed", "selected", "focused"]);
    ...
    obj = new nexacro.Style_color("#b9d8ff");
    this._addCss("Menu", "itemcolor", obj, ["mouseover", "pushed", "selected", "focused"]);
    this._addCss("MenuControl", "itemcolor", obj, ["mouseover", "pushed", "selected", "focused"]);

    obj = new nexacro.Style_color("#77fffb");
    ...
    this._addCss("MenuControl", "color", obj, ["disabled"]);
    ...
    obj = new nexacro.Style_value("theme://images/img_progress.png");
    ...
    obj = new nexacro.Style_value("theme://images/img_progress_D.png");
