(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("performance_guide.xfdl", function(exports) {

        this.performance_guide_onload = function(obj,e)
        {
        	this.fn_resize();
        	this.wbs.set_url("http://docs.tobesoft.com/nexacro_performance_guide_ko#");
        }
        ...
        this.loadIncludeScript("performance_guide.xfdl", true);
