			...
			if (_doc.hasFocus) {
				...
				if (is_active_window && input_handle.setSelectionRange) {
					if (input_handle == _doc.activeElement) {
						...
						_doc.getSelection().addRange(_doc.createRange());
					}
				}
