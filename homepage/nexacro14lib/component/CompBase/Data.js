...
if (!nexacro.Dataset) {
	...
	_pExprParser.tokenizeExpr = function (expr_str) {
		...
		if (expr_str && expr_str.indexOf(".match") > -1) {
		...
		while (true) {
			...
			if (tok in this.wordchars || test_whitespace || this.regexp_hangul.test(tok) || this.regexp_hanja.test(tok) || this.regexp_nipon.test(tok)) {
				if (cur_pos < src_len) {
					c = src.charAt(cur_pos);
					while (c in this.wordchars || test_whitespace || this.regexp_hangul.test(c) || this.regexp_hanja.test(c) || this.regexp_nipon.test(c)) {
						tok += c;
						cur_pos++;
						if (cur_pos >= src_len) {
							break;
	...
	_pDataset._createSortFunc = function () {
		...
		return function (a, b) {
			for (var i = _keycnt - 1; i >= 0; i--) {
				...
				if (_type != "string") {
					if (value1 == null
						 || (value1 == 0 && value1.hi == null && value1.lo == null)) {
						if (value2 == null
							 || (value2 == 0 && value2.hi == null && value2.lo == null)) {
