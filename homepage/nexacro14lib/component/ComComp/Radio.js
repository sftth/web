...
if (!nexacro.RadioItemCtrl) {
	...
	_pRadioItemCtrl.on_lbuttondown_basic_action = function (elem, button, alt_key, ctrl_key, shift_key, canvasX, canvasY, screenX, screenY, event_bubbles, fire_comp, refer_comp, bubble_scope) {
	...
	_pRadioItemCtrl.on_mousemove_basic_action = function () {
	...
	_pImageRadioCtrl.on_find_CurrentStyle_background = function (pseudo) {
		return this.parent.on_find_CurrentStyle_buttonbackground(this.parent._pseudo);
	};

	_pImageRadioCtrl.on_find_CurrentStyle_buttonbackgroundimagemode = function (pseudo) {
		return this.parent.on_find_CurrentStyle_buttonbackgroundimagemode(this.parent._pseudo);
	};

	_pImageRadioCtrl.on_find_CurrentStyle_image = function (pseudo) {
		return this.parent.on_find_CurrentStyle_buttonimage(this.parent._pseudo);
	};

	_pImageRadioCtrl.on_find_CurrentStyle_border = function (pseudo) {
		return this.parent.on_find_CurrentStyle_buttonborder(this.parent._pseudo);
	};

	_pImageRadioCtrl.on_find_CurrentStyle_gradation = function (pseudo) {
		return this.parent.on_find_CurrentStyle_buttongradation(this.parent._pseudo);
	};
	...
	_pImageRadioCtrl.on_mousemove_basic_action = function () {
		if (this._apply_pushed_pseudo && this._is_push) {
			this._stat_change("push", "pushed");
			this._is_pushed_area = true;
		}
	...
	_pImageRadioCtrl.on_mouseleave_basic_action = function (is_subcontrol_bubble) {
		if (is_subcontrol_bubble) {
			if (this._apply_pushed_pseudo && this._is_push) {
				this._stat_change("notpush", "normal");
				this._is_pushed_area = false;
			}
			else if (!this.parent._isSelected()) {
				var tmp_comp = this;
				var alive = true;
