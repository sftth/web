(function()
{
    return function()
    {
        ...
        ***********************************************************************************************/
        ...
        {
        	Base.XComp.setUserProperty(this, "listCount", listCount);
        	Base.XComp.setUserProperty(this, "pageCount", pageCount);
        	Base.XComp.setUserProperty(this, "currentPage", 1);
        	Base.XComp.setUserProperty(this, "pageChangeNotify", pageChangeNotify);
        	Base.XComp.setUserProperty(this, "scope", scope);
        	...
        	// 생성된 컴포넌트 참조 속성 추가
        	Base.XComp.setUserProperty(this, "pageComps", comps);
        ...
        this.pagingOnClickHandler = function(obj,e) 
        {
        	...
        	// 현재 선택된 페이지번호를 지정
        	var page = Base.XComp.getUserProperty(obj, "pageNumber");
        	
        	// 현재 페이지 지정
        	Base.XComp.setUserProperty(this, "currentPage", page);	
        ...
        this.pagingOnKeyDownHandler = function(obj,e) 
        {
        	if ( e.keycode == 13 )
        	{
        		var totalPage = Base.XComp.getUserProperty(obj, "totalPage");
        		var page = obj.value;

        		if ( !Base.isEmpty(page) )
        		{
        			page = parseInt(page);
        			if ( totalPage < page ) 
        			{
        				obj.set_value(Base.XComp.getUserProperty(this, "currentPage"));
        			}
        			else
        			{
        				// 현재 페이지 지정
        ...
        {	
        	// pageChangeNotify 호출
        	var func = Base.XComp.getUserProperty(this, "pageChangeNotify");
        	var scope = Base.XComp.getUserProperty(this, "scope");
        ...
        this.setPage = function(totalCount) 
        {
        	...
        	// 총건수를 담아두자.
        	Base.XComp.setUserProperty(this, "totalCount", totalCount);
        	
        	var listCount = Base.XComp.getUserProperty(this, "listCount");
        	var pageCount = Base.XComp.getUserProperty(this, "pageCount");
        	var currentPage = Base.XComp.getUserProperty(this, "currentPage");

        	var comp;
        	var comps = Base.XComp.getUserProperty(this, "pageComps");
        	...
        	{	
        		...
        		// 총 페이지 건수를 담아두자.
        		Base.XComp.setUserProperty(inputPageComp, "totalPage", totalPage);
        		
        		totalPageComp.set_text("of " + totalPage);
        		
        		var sz = Base.XComp.PositionSize.getContentSize(totalPageComp);
        ...
        {	
        	...
        	Base.XComp.setUserProperty(comp, "pageNumber", pageNumber);

        	var width = height = 0;
        	if ( !Base.isNull(size) ) 
        	{
        		if ( Base.isArray(size) ) 
        		{
        			width = size[0];
        			height = size[1];
        		} 
        	...
        	if ( !Base.isEmpty(text) ) 
        	{
        		...
        		var sz = Base.XComp.PositionSize.getTextSize(comp, text, false);
        		width = sz[0] + 2;
        		height = sz[1] + 2;
        	}
        ...
        {
        	return Base.XComp.setUserProperty(this, "currentPage", page);
        }
        ...
        {
        	return Base.XComp.getUserProperty(this, "currentPage");
        }

        this.Paging_onsize = function(obj,e)
        {
        	var nTotalCnt = Base.XComp.getUserProperty(this, "totalCount");
        	if(!Base.isEmpty(nTotalCnt))
        	{
        		this.setPage(nTotalCnt) ;
        	}
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onsize", this.Paging_onsize, this);
